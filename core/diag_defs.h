...
typedef struct { int id; const char *name; } diag_cmd_name_t;
...
typedef struct { int id; const char *name; } diag_subsys_name_t;
...
static const diag_subsys_name_t diag_subsys_map[] = {
    ...
    { DIAG_SUBSYS_USCRIPT,  "DIAG_SUBSYS_NAS" },    /* NAS — often contains registration / serving cell info */ //
