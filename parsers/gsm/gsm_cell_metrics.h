...
// ─────────────────────────────────────────────────────────────────────────────
enum class GsmBand : uint8_t { UNKNOWN = 0, GSM850, GSM900, DCS1800, PCS1900, GSM450, GSM480 };
...
inline const char* gsm_band_name(GsmBand b) {
    switch (b) {
        case GsmBand::GSM850:  return "GSM850";
        case GsmBand::GSM900:  return "GSM900";
        case GsmBand::DCS1800: return "DCS1800";
        case GsmBand::PCS1900: return "PCS1900";
        case GsmBand::GSM450:  return "GSM450";
        case GsmBand::GSM480:  return "GSM480";
        default:               return "";
    }
}
...
inline int ms_max_power_dbm(GsmBand b) {
    switch (b) {
        ...
        case GsmBand::PCS1900: return 30;   // class 1 (1 W)
        default:               return 33;   // GSM850/900 class 4 (2 W)
    }
}
...
// ─────────────────────────────────────────────────────────────────────────────
struct BitReader {
    const uint8_t* p; size_t nbits; size_t pos = 0;
