...
static asn_oer_constraints_t asn_OER_type_DL_HSPDSCH_TS_Configuration_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..13)) */};
asn_per_constraints_t asn_PER_type_DL_HSPDSCH_TS_Configuration_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_DL_HSPDSCH_TS_Configuration_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_Member_2,
...
asn_SET_OF_specifics_t asn_SPC_DL_HSPDSCH_TS_Configuration_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_DL_HSPDSCH_TS_Configuration = {
	...
	sizeof(asn_DEF_DL_HSPDSCH_TS_Configuration_tags_1)
		/sizeof(asn_DEF_DL_HSPDSCH_TS_Configuration_tags_1[0]), /* 1 */
	{ &asn_OER_type_DL_HSPDSCH_TS_Configuration_constr_1, &asn_PER_type_DL_HSPDSCH_TS_Configuration_constr_1, SEQUENCE_OF_constraint },
