...
asn_TYPE_member_t asn_MBR_UE_Positioning_GANSS_Almanac_r8_1[] = {
...
static const int asn_MAP_UE_Positioning_GANSS_Almanac_r8_oms_1[] = { 1, 2, 3, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_UE_Positioning_GANSS_Almanac_r8_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_Positioning_GANSS_Almanac_r8_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ganss-wk-number */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* alm-keplerianParameters */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* alm-keplerianNAVAlmanac */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* alm-keplerianReducedAlmanac */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* alm-keplerianMidiAlmanac */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* alm-keplerianGLONASS */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* alm-ecefSBASAlmanac */
};
asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_GANSS_Almanac_r8_specs_1 = {
