 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_loggedMeasAvailable_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_loggedMeasAvailable_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_loggedANRResultsAvailable_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_loggedANRResultsAvailable_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_loggedMeasAvailable_value2enum_3[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_loggedMeasAvailable_enum2value_3[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_loggedMeasAvailable_specs_3 = {
...
static const ber_tlv_tag_t asn_DEF_loggedMeasAvailable_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_loggedMeasAvailable_3 = {
	...
	{ &asn_OER_type_loggedMeasAvailable_constr_3, &asn_PER_type_loggedMeasAvailable_constr_3, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_loggedMeasAvailable_specs_3	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_loggedANRResultsAvailable_value2enum_5[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_loggedANRResultsAvailable_enum2value_5[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_loggedANRResultsAvailable_specs_5 = {
...
static const ber_tlv_tag_t asn_DEF_loggedANRResultsAvailable_tags_5[] = {
...
asn_TYPE_descriptor_t asn_DEF_loggedANRResultsAvailable_5 = {
	...
	{ &asn_OER_type_loggedANRResultsAvailable_constr_5, &asn_PER_type_loggedANRResultsAvailable_constr_5, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_loggedANRResultsAvailable_specs_5	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_MeasurementReport_va40ext_IEs_1[] = {
...
static const int asn_MAP_MeasurementReport_va40ext_IEs_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_MeasurementReport_va40ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MeasurementReport_va40ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eventResults */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* loggedMeasAvailable */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* loggedANRResultsAvailable */
};
asn_SEQUENCE_specifics_t asn_SPC_MeasurementReport_va40ext_IEs_specs_1 = {
