...
static asn_oer_constraints_t asn_OER_type_LoggedMeasLocationInfo_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_LoggedMeasLocationInfo_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_LoggedMeasLocationInfo_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_LoggedMeasLocationInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ellipsoidPoint */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ellipsoidPointAltitude */
};
asn_CHOICE_specifics_t asn_SPC_LoggedMeasLocationInfo_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_LoggedMeasLocationInfo = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LoggedMeasLocationInfo_constr_1, &asn_PER_type_LoggedMeasLocationInfo_constr_1, CHOICE_constraint },
