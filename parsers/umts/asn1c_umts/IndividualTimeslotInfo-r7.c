...
asn_TYPE_member_t asn_MBR_IndividualTimeslotInfo_r7_1[] = {
...
static const ber_tlv_tag_t asn_DEF_IndividualTimeslotInfo_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_IndividualTimeslotInfo_r7_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_IndividualTimeslotInfo_r7_specs_1 = {
