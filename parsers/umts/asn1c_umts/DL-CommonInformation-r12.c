...
static asn_TYPE_member_t asn_MBR_dl_dpchInfoCommon_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12__dl_dpchInfoCommon, choice.dl_DPCH_InfoCommon),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12__dl_dpchInfoCommon, choice.dl_FDPCH_InfoCommon),
...
static asn_CHOICE_specifics_t asn_SPC_dl_dpchInfoCommon_specs_2 = {
	sizeof(struct DL_CommonInformation_r12__dl_dpchInfoCommon),
	offsetof(struct DL_CommonInformation_r12__dl_dpchInfoCommon, _asn_ctx),
	offsetof(struct DL_CommonInformation_r12__dl_dpchInfoCommon, present),
	sizeof(((struct DL_CommonInformation_r12__dl_dpchInfoCommon *)0)->present),
...
static asn_TYPE_member_t asn_MBR_fdd_6[] = {
	{ ATF_POINTER, 3, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__fdd, defaultDPCH_OffsetValue),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__fdd, dpch_CompressedModeInfo),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__fdd, tx_DiversityMode),
...
static asn_SEQUENCE_specifics_t asn_SPC_fdd_specs_6 = {
	sizeof(struct DL_CommonInformation_r12__modeSpecificInfo__fdd),
	offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__fdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_tdd128_14[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption__tdd128, tstd_Indicator),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BOOLEAN,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_tdd128_specs_14 = {
	sizeof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption__tdd128),
	offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption__tdd128, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_tddOption_11[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption, choice.tdd384),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption, choice.tdd768),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption, choice.tdd128),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_tdd128_14,
		0,
...
static asn_CHOICE_specifics_t asn_SPC_tddOption_specs_11 = {
	sizeof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption),
	offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption, _asn_ctx),
	offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption, present),
	sizeof(((struct DL_CommonInformation_r12__modeSpecificInfo__tdd__tddOption *)0)->present),
...
static asn_TYPE_member_t asn_MBR_tdd_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd, tddOption),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd, defaultDPCH_OffsetValue),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_tdd_specs_10 = {
	sizeof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd),
	offsetof(struct DL_CommonInformation_r12__modeSpecificInfo__tdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_modeSpecificInfo_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo, choice.fdd),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_fdd_6,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12__modeSpecificInfo, choice.tdd),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_tdd_10,
		0,
...
static asn_CHOICE_specifics_t asn_SPC_modeSpecificInfo_specs_5 = {
	sizeof(struct DL_CommonInformation_r12__modeSpecificInfo),
	offsetof(struct DL_CommonInformation_r12__modeSpecificInfo, _asn_ctx),
	offsetof(struct DL_CommonInformation_r12__modeSpecificInfo, present),
	sizeof(((struct DL_CommonInformation_r12__modeSpecificInfo *)0)->present),
...
asn_TYPE_member_t asn_MBR_DL_CommonInformation_r12_1[] = {
	{ ATF_POINTER, 1, offsetof(struct DL_CommonInformation_r12, dl_dpchInfoCommon),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CommonInformation_r12, modeSpecificInfo),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct DL_CommonInformation_r12, mac_hsResetIndicator),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct DL_CommonInformation_r12, postVerificationPeriod),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct DL_CommonInformation_r12, mac_hsResetIndicator_assisting),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_DL_CommonInformation_r12_oms_1[] = { 0, 2, 3, 4 };
static const ber_tlv_tag_t asn_DEF_DL_CommonInformation_r12_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DL_CommonInformation_r12_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_DL_CommonInformation_r12_specs_1 = {
	sizeof(struct DL_CommonInformation_r12),
	offsetof(struct DL_CommonInformation_r12, _asn_ctx),
	asn_MAP_DL_CommonInformation_r12_tag2el_1,
	5,	/* Count of tags in the map */
	asn_MAP_DL_CommonInformation_r12_oms_1,	/* Optional members */
	4, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_DL_CommonInformation_r12 = {
	"DL-CommonInformation-r12",
	"DL-CommonInformation-r12",
	&asn_OP_SEQUENCE,
	asn_DEF_DL_CommonInformation_r12_tags_1,
	sizeof(asn_DEF_DL_CommonInformation_r12_tags_1)
		/sizeof(asn_DEF_DL_CommonInformation_r12_tags_1[0]), /* 1 */
	asn_DEF_DL_CommonInformation_r12_tags_1,	/* Same as above */
	sizeof(asn_DEF_DL_CommonInformation_r12_tags_1)
		/sizeof(asn_DEF_DL_CommonInformation_r12_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_DL_CommonInformation_r12_1,
	5,	/* Elements count */
	&asn_SPC_DL_CommonInformation_r12_specs_1	/* Additional specs */
};
