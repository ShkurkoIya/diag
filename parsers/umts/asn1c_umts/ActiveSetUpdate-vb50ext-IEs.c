...
asn_TYPE_member_t asn_MBR_ActiveSetUpdate_vb50ext_IEs_1[] = {
...
static const int asn_MAP_ActiveSetUpdate_vb50ext_IEs_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_ActiveSetUpdate_vb50ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ActiveSetUpdate_vb50ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ulOLTDInfoFDD */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* rl-AdditionInformationList */
};
asn_SEQUENCE_specifics_t asn_SPC_ActiveSetUpdate_vb50ext_IEs_specs_1 = {
