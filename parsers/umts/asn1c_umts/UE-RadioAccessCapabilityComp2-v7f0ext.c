...
asn_TYPE_member_t asn_MBR_UE_RadioAccessCapabilityComp2_v7f0ext_1[] = {
...
static const int asn_MAP_UE_RadioAccessCapabilityComp2_v7f0ext_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_UE_RadioAccessCapabilityComp2_v7f0ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapabilityComp2_v7f0ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* supportofTxDivOnNonMIMOChannel */
};
asn_SEQUENCE_specifics_t asn_SPC_UE_RadioAccessCapabilityComp2_v7f0ext_specs_1 = {
