...
extern asn_SEQUENCE_specifics_t asn_SPC_NeighCellSI_AcquisitionCapability_specs_1;
extern asn_TYPE_member_t asn_MBR_NeighCellSI_AcquisitionCapability_1[3];
