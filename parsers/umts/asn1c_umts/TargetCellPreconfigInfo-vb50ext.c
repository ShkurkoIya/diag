...
asn_TYPE_member_t asn_MBR_TargetCellPreconfigInfo_vb50ext_1[] = {
...
static const int asn_MAP_TargetCellPreconfigInfo_vb50ext_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_TargetCellPreconfigInfo_vb50ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_TargetCellPreconfigInfo_vb50ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* ulOLTDInfoFDD */
};
asn_SEQUENCE_specifics_t asn_SPC_TargetCellPreconfigInfo_vb50ext_specs_1 = {
