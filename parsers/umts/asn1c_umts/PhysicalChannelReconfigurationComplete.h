...
extern asn_SEQUENCE_specifics_t asn_SPC_PhysicalChannelReconfigurationComplete_specs_1;
extern asn_TYPE_member_t asn_MBR_PhysicalChannelReconfigurationComplete_1[7];
