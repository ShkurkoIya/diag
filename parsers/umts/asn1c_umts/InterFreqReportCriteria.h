...
extern asn_CHOICE_specifics_t asn_SPC_InterFreqReportCriteria_specs_1;
extern asn_TYPE_member_t asn_MBR_InterFreqReportCriteria_1[4];
extern asn_per_constraints_t asn_PER_type_InterFreqReportCriteria_constr_1;
