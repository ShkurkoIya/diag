...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_GERANIu_RadioAccessCapability_constr_1;
...
oer_type_decoder_f GERANIu_RadioAccessCapability_decode_oer;
oer_type_encoder_f GERANIu_RadioAccessCapability_encode_oer;
