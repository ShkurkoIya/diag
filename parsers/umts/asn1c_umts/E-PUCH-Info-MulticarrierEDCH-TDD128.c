...
static asn_oer_constraints_t asn_OER_type_e_PUCH_TS_ConfigurationList_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..5)) */};
static asn_per_constraints_t asn_PER_type_e_PUCH_TS_ConfigurationList_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  5 }	/* (SIZE(1..5)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_e_PUCH_TS_ConfigurationList_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..5)) */};
static asn_per_constraints_t asn_PER_memb_e_PUCH_TS_ConfigurationList_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  5 }	/* (SIZE(1..5)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_e_PUCH_TS_ConfigurationList_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_e_PUCH_TS_ConfigurationList_2 = {
	...
	{ &asn_OER_type_e_PUCH_TS_ConfigurationList_constr_2, &asn_PER_type_e_PUCH_TS_ConfigurationList_constr_2, SEQUENCE_OF_constraint },
	asn_MBR_e_PUCH_TS_ConfigurationList_2,
	1,	/* Single element */
	&asn_SPC_e_PUCH_TS_ConfigurationList_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_E_PUCH_Info_MulticarrierEDCH_TDD128_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E_PUCH_Info_MulticarrierEDCH_TDD128, e_PUCH_TS_ConfigurationList),
		...
		0,
		{ &asn_OER_memb_e_PUCH_TS_ConfigurationList_constr_2, &asn_PER_memb_e_PUCH_TS_ConfigurationList_constr_2,  memb_e_PUCH_TS_ConfigurationList_constraint_1 },
		0, 0, /* No default value */
		"e-PUCH-TS-ConfigurationList"
		},
};
static const ber_tlv_tag_t asn_DEF_E_PUCH_Info_MulticarrierEDCH_TDD128_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_E_PUCH_Info_MulticarrierEDCH_TDD128_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* e-PUCH-TS-ConfigurationList */
};
asn_SEQUENCE_specifics_t asn_SPC_E_PUCH_Info_MulticarrierEDCH_TDD128_specs_1 = {
