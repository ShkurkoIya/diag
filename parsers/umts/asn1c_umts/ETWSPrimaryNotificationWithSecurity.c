...
asn_TYPE_member_t asn_MBR_ETWSPrimaryNotificationWithSecurity_1[] = {
...
static const int asn_MAP_ETWSPrimaryNotificationWithSecurity_oms_1[] = { 1, 2 };
static const ber_tlv_tag_t asn_DEF_ETWSPrimaryNotificationWithSecurity_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ETWSPrimaryNotificationWithSecurity_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_ETWSPrimaryNotificationWithSecurity_specs_1 = {
