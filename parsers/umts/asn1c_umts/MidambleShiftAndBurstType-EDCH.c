...
static const asn_TYPE_tag2member_t asn_MAP_type1_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* midambleConfigurationBurstType1 */
...
asn_TYPE_member_t asn_MBR_MidambleShiftAndBurstType_EDCH_1[] = {
...
static const ber_tlv_tag_t asn_DEF_MidambleShiftAndBurstType_EDCH_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MidambleShiftAndBurstType_EDCH_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* burstType */
};
asn_SEQUENCE_specifics_t asn_SPC_MidambleShiftAndBurstType_EDCH_specs_1 = {
