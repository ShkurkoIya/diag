...
static const asn_TYPE_tag2member_t asn_MAP_va40NonCriticalExtensions_tag2el_9[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionSetupCompleteBand-va40ext */
...
static const asn_TYPE_tag2member_t asn_MAP_v7f0NonCriticalExtensions_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionSetupComplete-v7f0ext */
...
static const asn_TYPE_tag2member_t asn_MAP_v7e0NonCriticalExtensions_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionSetupComplete-v7e0ext */
