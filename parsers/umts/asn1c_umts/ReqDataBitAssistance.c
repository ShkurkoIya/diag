...
static int
memb_ganssSatelliteInfo_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static asn_oer_constraints_t asn_OER_type_ganssSatelliteInfo_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
static asn_per_constraints_t asn_PER_type_ganssSatelliteInfo_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_ganssDataBitInterval_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_ganssSatelliteInfo_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
static asn_per_constraints_t asn_PER_memb_ganssSatelliteInfo_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_ganssSatelliteInfo_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_ganssSatelliteInfo_4 = {
	...
	{ &asn_OER_type_ganssSatelliteInfo_constr_4, &asn_PER_type_ganssSatelliteInfo_constr_4, SEQUENCE_OF_constraint },
	asn_MBR_ganssSatelliteInfo_4,
	1,	/* Single element */
	&asn_SPC_ganssSatelliteInfo_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_ReqDataBitAssistance_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ReqDataBitAssistance, ganssDataBitInterval),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_ganssDataBitInterval_constr_3, &asn_PER_memb_ganssDataBitInterval_constr_3,  memb_ganssDataBitInterval_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct ReqDataBitAssistance, ganssSatelliteInfo),
		...
		0,
		{ &asn_OER_memb_ganssSatelliteInfo_constr_4, &asn_PER_memb_ganssSatelliteInfo_constr_4,  memb_ganssSatelliteInfo_constraint_1 },
		0, 0, /* No default value */
		"ganssSatelliteInfo"
		},
};
static const int asn_MAP_ReqDataBitAssistance_oms_1[] = { 2 };
static const ber_tlv_tag_t asn_DEF_ReqDataBitAssistance_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ReqDataBitAssistance_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ganssSignalID */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ganssDataBitInterval */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ganssSatelliteInfo */
};
asn_SEQUENCE_specifics_t asn_SPC_ReqDataBitAssistance_specs_1 = {
