...
asn_TYPE_member_t asn_MBR_E_DCH_ReconfigurationInfo_r7_1[] = {
...
static const int asn_MAP_E_DCH_ReconfigurationInfo_r7_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_E_DCH_ReconfigurationInfo_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_E_DCH_ReconfigurationInfo_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* e-DCH-RL-InfoNewServingCell */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* e-DCH-RL-InfoOtherCellList */
};
asn_SEQUENCE_specifics_t asn_SPC_E_DCH_ReconfigurationInfo_r7_specs_1 = {
