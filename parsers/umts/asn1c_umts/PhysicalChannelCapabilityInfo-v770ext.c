...
static const ber_tlv_tag_t asn_DEF_tddPhysChCapability_768_tags_2[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_tddPhysChCapability_768_tag2el_2[] = {
...
static const ber_tlv_tag_t asn_DEF_tddPhysChCapability_128_tags_5[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_tddPhysChCapability_128_tag2el_5[] = {
...
asn_TYPE_member_t asn_MBR_PhysicalChannelCapabilityInfo_v770ext_1[] = {
...
static const int asn_MAP_PhysicalChannelCapabilityInfo_v770ext_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_PhysicalChannelCapabilityInfo_v770ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PhysicalChannelCapabilityInfo_v770ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tddPhysChCapability-768 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tddPhysChCapability-128 */
};
asn_SEQUENCE_specifics_t asn_SPC_PhysicalChannelCapabilityInfo_v770ext_specs_1 = {
