...
static asn_oer_constraints_t asn_OER_type_DL_DPCH_InfoPerRL_r7_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_DL_DPCH_InfoPerRL_r7_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_DL_DPCH_InfoPerRL_r7_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_DL_DPCH_InfoPerRL_r7_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_DL_DPCH_InfoPerRL_r7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_DL_DPCH_InfoPerRL_r7_constr_1, &asn_PER_type_DL_DPCH_InfoPerRL_r7_constr_1, CHOICE_constraint },
