...
static const int asn_MAP_fdd_oms_5[] = { 1, 2, 3, 4 };
...
static const asn_TYPE_tag2member_t asn_MAP_fdd_tag2el_5[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* deltaRSCPPerCell */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* pathloss */
};
...
asn_TYPE_member_t asn_MBR_CellMeasuredResults_r9_1[] = {
...
static const int asn_MAP_CellMeasuredResults_r9_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_CellMeasuredResults_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CellMeasuredResults_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellIdentity */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* cellSynchronisationInfo */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* modeSpecificInfo */
};
asn_SEQUENCE_specifics_t asn_SPC_CellMeasuredResults_r9_specs_1 = {
