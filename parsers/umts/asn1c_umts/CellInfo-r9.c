...
asn_TYPE_member_t asn_MBR_CellInfo_r9_1[] = {
...
static const int asn_MAP_CellInfo_r9_oms_1[] = { 0, 1, 3 };
static const ber_tlv_tag_t asn_DEF_CellInfo_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CellInfo_r9_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_CellInfo_r9_specs_1 = {
