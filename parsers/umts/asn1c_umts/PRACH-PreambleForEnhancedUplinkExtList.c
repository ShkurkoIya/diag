...
static asn_oer_constraints_t asn_OER_type_PRACH_PreambleForEnhancedUplinkExtList_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
asn_per_constraints_t asn_PER_type_PRACH_PreambleForEnhancedUplinkExtList_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_PRACH_PreambleForEnhancedUplinkExtList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static const ber_tlv_tag_t asn_DEF_PRACH_PreambleForEnhancedUplinkExtList_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_SET_OF_specifics_t asn_SPC_PRACH_PreambleForEnhancedUplinkExtList_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PRACH_PreambleForEnhancedUplinkExtList = {
	...
	sizeof(asn_DEF_PRACH_PreambleForEnhancedUplinkExtList_tags_1)
		/sizeof(asn_DEF_PRACH_PreambleForEnhancedUplinkExtList_tags_1[0]), /* 1 */
	{ &asn_OER_type_PRACH_PreambleForEnhancedUplinkExtList_constr_1, &asn_PER_type_PRACH_PreambleForEnhancedUplinkExtList_constr_1, SEQUENCE_OF_constraint },
