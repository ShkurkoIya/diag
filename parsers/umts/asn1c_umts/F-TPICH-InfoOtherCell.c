...
static asn_oer_constraints_t asn_OER_type_f_tpich_Info_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_f_tpich_Info_constr_3 CC_NOTUSED = {
...
static const asn_TYPE_tag2member_t asn_MAP_f_tpich_Info_tag2el_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_f_tpich_Info_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_f_tpich_Info_constr_3, &asn_PER_type_f_tpich_Info_constr_3, CHOICE_constraint },
	asn_MBR_f_tpich_Info_3,
	2,	/* Elements count */
	&asn_SPC_f_tpich_Info_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_F_TPICH_InfoOtherCell_1[] = {
...
static const ber_tlv_tag_t asn_DEF_F_TPICH_InfoOtherCell_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_F_TPICH_InfoOtherCell_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* primaryCPICH-Info */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* f-tpich-Info */
};
asn_SEQUENCE_specifics_t asn_SPC_F_TPICH_InfoOtherCell_specs_1 = {
