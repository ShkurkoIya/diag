...
static int
memb_roundTripTime_constraint_10(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_roundTripTimeExtension_constraint_10(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_roundTripTime_constr_12 CC_NOTUSED = {
	{ 2, 1 }	/* (0..32766) */,
	-1};
static asn_per_constraints_t asn_PER_memb_roundTripTime_constr_12 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 15,  15,  0,  32766 }	/* (0..32766) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_roundTripTimeExtension_constr_13 CC_NOTUSED = {
	{ 4, 1 }	/* (0..70274) */,
	-1};
static asn_per_constraints_t asn_PER_memb_roundTripTimeExtension_constr_13 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ueBased_10[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct UE_Positioning_OTDOA_ReferenceCellInfo_r7__positioningMode__ueBased, roundTripTime),
		...
		0,
		{ &asn_OER_memb_roundTripTime_constr_12, &asn_PER_memb_roundTripTime_constr_12,  memb_roundTripTime_constraint_10 },
		0, 0, /* No default value */
		"roundTripTime"
		},
	{ ATF_POINTER, 1, offsetof(struct UE_Positioning_OTDOA_ReferenceCellInfo_r7__positioningMode__ueBased, roundTripTimeExtension),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_roundTripTimeExtension_constr_13, &asn_PER_memb_roundTripTimeExtension_constr_13,  memb_roundTripTimeExtension_constraint_10 },
		0, 0, /* No default value */
		"roundTripTimeExtension"
		},
};
static const int asn_MAP_ueBased_oms_10[] = { 0, 1, 2 };
...
static const asn_TYPE_tag2member_t asn_MAP_ueBased_tag2el_10[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* roundTripTimeExtension */
};
...
asn_TYPE_member_t asn_MBR_UE_Positioning_OTDOA_ReferenceCellInfo_r7_1[] = {
...
static const int asn_MAP_UE_Positioning_OTDOA_ReferenceCellInfo_r7_oms_1[] = { 0, 2, 4 };
static const ber_tlv_tag_t asn_DEF_UE_Positioning_OTDOA_ReferenceCellInfo_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_Positioning_OTDOA_ReferenceCellInfo_r7_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_OTDOA_ReferenceCellInfo_r7_specs_1 = {
