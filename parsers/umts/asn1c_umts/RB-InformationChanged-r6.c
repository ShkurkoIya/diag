...
static asn_oer_constraints_t asn_OER_type_rb_Change_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_rb_Change_constr_3 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_rb_Change_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_rb_Change_constr_3, &asn_PER_type_rb_Change_constr_3, CHOICE_constraint },
	asn_MBR_rb_Change_3,
	2,	/* Elements count */
	&asn_SPC_rb_Change_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_RB_InformationChanged_r6_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_RB_InformationChanged_r6_specs_1 = {
