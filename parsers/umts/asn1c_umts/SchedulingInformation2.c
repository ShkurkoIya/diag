...
static asn_oer_constraints_t asn_OER_type_SchedulingInformation2_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_SchedulingInformation2_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_sib_Pos_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep4),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep8),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep32),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep64),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep128),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep256),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep512),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep1024),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep2048),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling__sib_Pos, choice.rep4096),
...
static asn_CHOICE_specifics_t asn_SPC_sib_Pos_specs_4 = {
	sizeof(struct SchedulingInformation2__scheduling__sib_Pos),
	offsetof(struct SchedulingInformation2__scheduling__sib_Pos, _asn_ctx),
	offsetof(struct SchedulingInformation2__scheduling__sib_Pos, present),
	sizeof(((struct SchedulingInformation2__scheduling__sib_Pos *)0)->present),
...
static asn_TYPE_member_t asn_MBR_scheduling_2[] = {
	{ ATF_POINTER, 1, offsetof(struct SchedulingInformation2__scheduling, segCount),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SegCount,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2__scheduling, sib_Pos),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct SchedulingInformation2__scheduling, sib_PosOffsetInfo),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_scheduling_specs_2 = {
	sizeof(struct SchedulingInformation2__scheduling),
	offsetof(struct SchedulingInformation2__scheduling, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SchedulingInformation2_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingInformation2, choice.scheduling),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_SchedulingInformation2_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* scheduling */
};
asn_CHOICE_specifics_t asn_SPC_SchedulingInformation2_specs_1 = {
	sizeof(struct SchedulingInformation2),
	offsetof(struct SchedulingInformation2, _asn_ctx),
	offsetof(struct SchedulingInformation2, present),
	sizeof(((struct SchedulingInformation2 *)0)->present),
	asn_MAP_SchedulingInformation2_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_SchedulingInformation2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_SchedulingInformation2_constr_1, &asn_PER_type_SchedulingInformation2_constr_1, CHOICE_constraint },
	asn_MBR_SchedulingInformation2_1,
	1,	/* Elements count */
	&asn_SPC_SchedulingInformation2_specs_1	/* Additional specs */
};
