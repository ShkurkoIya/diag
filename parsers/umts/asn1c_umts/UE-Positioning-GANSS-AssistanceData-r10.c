...
asn_TYPE_member_t asn_MBR_UE_Positioning_GANSS_AssistanceData_r10_1[] = {
...
static const int asn_MAP_UE_Positioning_GANSS_AssistanceData_r10_oms_1[] = { 0, 1, 2, 3, 4, 5 };
static const ber_tlv_tag_t asn_DEF_UE_Positioning_GANSS_AssistanceData_r10_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_Positioning_GANSS_AssistanceData_r10_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_GANSS_AssistanceData_r10_specs_1 = {
