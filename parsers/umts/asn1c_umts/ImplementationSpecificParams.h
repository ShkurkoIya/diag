...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_ImplementationSpecificParams_constr_1;
...
oer_type_decoder_f ImplementationSpecificParams_decode_oer;
oer_type_encoder_f ImplementationSpecificParams_encode_oer;
