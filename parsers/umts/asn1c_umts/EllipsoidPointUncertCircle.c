...
static asn_oer_constraints_t asn_OER_memb_uncertaintyCode_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..127) */,
	-1};
static asn_per_constraints_t asn_PER_memb_uncertaintyCode_constr_7 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_EllipsoidPointUncertCircle_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EllipsoidPointUncertCircle, uncertaintyCode),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertaintyCode_constr_7, &asn_PER_memb_uncertaintyCode_constr_7,  memb_uncertaintyCode_constraint_1 },
		0, 0, /* No default value */
		"uncertaintyCode"
		},
};
...
asn_SEQUENCE_specifics_t asn_SPC_EllipsoidPointUncertCircle_specs_1 = {
