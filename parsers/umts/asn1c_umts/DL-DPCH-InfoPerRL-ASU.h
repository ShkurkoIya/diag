...
#ifndef	_DL_DPCH_InfoPerRL_ASU_H_
#define	_DL_DPCH_InfoPerRL_ASU_H_
...
/* Dependencies */
typedef enum DL_DPCH_InfoPerRL_ASU_PR {
	DL_DPCH_InfoPerRL_ASU_PR_NOTHING,	/* No components present */
	DL_DPCH_InfoPerRL_ASU_PR_fdd,
	DL_DPCH_InfoPerRL_ASU_PR_tdd
} DL_DPCH_InfoPerRL_ASU_PR;
...
typedef struct DL_DPCH_InfoPerRL_ASU {
	DL_DPCH_InfoPerRL_ASU_PR present;
	union DL_DPCH_InfoPerRL_ASU_u {
		struct DL_DPCH_InfoPerRL_ASU__fdd {
		...
		struct DL_DPCH_InfoPerRL_ASU__tdd {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} DL_DPCH_InfoPerRL_ASU_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_DL_DPCH_InfoPerRL_ASU;
extern asn_CHOICE_specifics_t asn_SPC_DL_DPCH_InfoPerRL_ASU_specs_1;
extern asn_TYPE_member_t asn_MBR_DL_DPCH_InfoPerRL_ASU_1[2];
extern asn_per_constraints_t asn_PER_type_DL_DPCH_InfoPerRL_ASU_constr_1;
...
#endif	/* _DL_DPCH_InfoPerRL_ASU_H_ */
