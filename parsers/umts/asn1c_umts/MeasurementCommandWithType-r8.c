...
static asn_oer_constraints_t asn_OER_type_MeasurementCommandWithType_r8_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_MeasurementCommandWithType_r8_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_MeasurementCommandWithType_r8_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_MeasurementCommandWithType_r8_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* setup */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* modify */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* release */
};
asn_CHOICE_specifics_t asn_SPC_MeasurementCommandWithType_r8_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_MeasurementCommandWithType_r8 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_MeasurementCommandWithType_r8_constr_1, &asn_PER_type_MeasurementCommandWithType_r8_constr_1, CHOICE_constraint },
