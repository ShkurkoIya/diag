...
static asn_oer_constraints_t asn_OER_type_RB_InformationAffectedList_r6_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
asn_per_constraints_t asn_PER_type_RB_InformationAffectedList_r6_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RB_InformationAffectedList_r6_1[] = {
	{ ATF_POINTER, 0, 0,
...
asn_SET_OF_specifics_t asn_SPC_RB_InformationAffectedList_r6_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_RB_InformationAffectedList_r6 = {
	...
	sizeof(asn_DEF_RB_InformationAffectedList_r6_tags_1)
		/sizeof(asn_DEF_RB_InformationAffectedList_r6_tags_1[0]), /* 1 */
	{ &asn_OER_type_RB_InformationAffectedList_r6_constr_1, &asn_PER_type_RB_InformationAffectedList_r6_constr_1, SEQUENCE_OF_constraint },
