...
static asn_oer_constraints_t asn_OER_memb_trackingAreaCode_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
static asn_per_constraints_t asn_PER_memb_trackingAreaCode_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  16,  16 }	/* (SIZE(16..16)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_CGI_Info_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CGI_Info, plmn_Identity),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CGI_Info, cellIdentity),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CGI_Info, trackingAreaCode),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_trackingAreaCode_constr_4, &asn_PER_memb_trackingAreaCode_constr_4,  memb_trackingAreaCode_constraint_1 },
		0, 0, /* No default value */
		"trackingAreaCode"
		},
};
