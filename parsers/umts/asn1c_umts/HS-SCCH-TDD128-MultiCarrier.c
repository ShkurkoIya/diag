...
static int
memb_ueSpecificMidamble_constraint_6(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_ueSpecificMidamble_constr_9 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
static asn_per_constraints_t asn_PER_memb_ueSpecificMidamble_constr_9 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  15 }	/* (0..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_midambleAllocationMode_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_midambleAllocationMode_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_midambleConfiguration_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
static asn_per_constraints_t asn_PER_memb_midambleConfiguration_constr_10 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_midambleAllocationMode_6[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HS_SCCH_TDD128_MultiCarrier__midambleAllocationMode, choice.ueSpecificMidamble),
		...
		0,
		{ &asn_OER_memb_ueSpecificMidamble_constr_9, &asn_PER_memb_ueSpecificMidamble_constr_9,  memb_ueSpecificMidamble_constraint_6 },
		0, 0, /* No default value */
		"ueSpecificMidamble"
		},
};
static const asn_TYPE_tag2member_t asn_MAP_midambleAllocationMode_tag2el_6[] = {
...
asn_TYPE_descriptor_t asn_DEF_midambleAllocationMode_6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_midambleAllocationMode_constr_6, &asn_PER_type_midambleAllocationMode_constr_6, CHOICE_constraint },
	asn_MBR_midambleAllocationMode_6,
	3,	/* Elements count */
	&asn_SPC_midambleAllocationMode_specs_6	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_HS_SCCH_TDD128_MultiCarrier_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HS_SCCH_TDD128_MultiCarrier, midambleConfiguration),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_midambleConfiguration_constr_10, &asn_PER_memb_midambleConfiguration_constr_10,  memb_midambleConfiguration_constraint_1 },
		0, 0, /* No default value */
...
static const ber_tlv_tag_t asn_DEF_HS_SCCH_TDD128_MultiCarrier_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_HS_SCCH_TDD128_MultiCarrier_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* uarfcn-HS-SCCH-Rx */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* timeslotNumber */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* firstChannelisationCode */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* secondChannelisationCode */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* midambleAllocationMode */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* midambleConfiguration */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* bler-target */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* hs-sich-configuration */
};
asn_SEQUENCE_specifics_t asn_SPC_HS_SCCH_TDD128_MultiCarrier_specs_1 = {
