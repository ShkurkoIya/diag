...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RoutingAreaCode_constr_1;
...
oer_type_decoder_f RoutingAreaCode_decode_oer;
oer_type_encoder_f RoutingAreaCode_encode_oer;
