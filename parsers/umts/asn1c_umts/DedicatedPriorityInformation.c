...
asn_TYPE_member_t asn_MBR_DedicatedPriorityInformation_1[] = {
...
static const ber_tlv_tag_t asn_DEF_DedicatedPriorityInformation_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DedicatedPriorityInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* action */
};
asn_SEQUENCE_specifics_t asn_SPC_DedicatedPriorityInformation_specs_1 = {
