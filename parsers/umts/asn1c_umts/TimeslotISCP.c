 ...
 */
static asn_oer_constraints_t asn_OER_type_TimeslotISCP_constr_1 CC_NOTUSED = {
	{ 1, 1 }	/* (0..127) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_TimeslotISCP = {
	...
	sizeof(asn_DEF_TimeslotISCP_tags_1)
		/sizeof(asn_DEF_TimeslotISCP_tags_1[0]), /* 1 */
	{ &asn_OER_type_TimeslotISCP_constr_1, &asn_PER_type_TimeslotISCP_constr_1, TimeslotISCP_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
