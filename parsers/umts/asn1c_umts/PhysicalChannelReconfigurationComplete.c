...
static const asn_TYPE_tag2member_t asn_MAP_v770NonCriticalExtensions_tag2el_10[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* physicalChannelReconfigurationComplete-v770ext */
...
asn_TYPE_member_t asn_MBR_PhysicalChannelReconfigurationComplete_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_PhysicalChannelReconfigurationComplete_specs_1 = {
