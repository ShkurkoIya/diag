 ...
 */
static asn_oer_constraints_t asn_OER_type_CellUpdateCause_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_CellUpdateCause_constr_1 CC_NOTUSED = {
...
const asn_INTEGER_specifics_t asn_SPC_CellUpdateCause_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_CellUpdateCause = {
	...
	sizeof(asn_DEF_CellUpdateCause_tags_1)
		/sizeof(asn_DEF_CellUpdateCause_tags_1[0]), /* 1 */
	{ &asn_OER_type_CellUpdateCause_constr_1, &asn_PER_type_CellUpdateCause_constr_1, NativeEnumerated_constraint },
