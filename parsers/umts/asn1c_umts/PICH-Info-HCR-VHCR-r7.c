...
static asn_oer_constraints_t asn_OER_type_channelisationCode_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_channelisationCode_constr_2 CC_NOTUSED = {
...
static const asn_TYPE_tag2member_t asn_MAP_channelisationCode_tag2el_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_channelisationCode_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_channelisationCode_constr_2, &asn_PER_type_channelisationCode_constr_2, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_PICH_Info_HCR_VHCR_r7_1[] = {
...
static const int asn_MAP_PICH_Info_HCR_VHCR_r7_oms_1[] = { 0, 1, 3, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_PICH_Info_HCR_VHCR_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PICH_Info_HCR_VHCR_r7_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_PICH_Info_HCR_VHCR_r7_specs_1 = {
