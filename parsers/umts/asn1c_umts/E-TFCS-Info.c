...
static int
memb_reference_Beta_QPSK_List_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_reference_Beta_16QAM_List_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static asn_oer_constraints_t asn_OER_type_reference_Beta_QPSK_List_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
static asn_per_constraints_t asn_PER_type_reference_Beta_QPSK_List_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_reference_Beta_16QAM_List_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
static asn_per_constraints_t asn_PER_type_reference_Beta_16QAM_List_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_reference_Beta_QPSK_List_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
static asn_per_constraints_t asn_PER_memb_reference_Beta_QPSK_List_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_reference_Beta_16QAM_List_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
static asn_per_constraints_t asn_PER_memb_reference_Beta_16QAM_List_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_reference_Beta_QPSK_List_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_reference_Beta_QPSK_List_2 = {
	...
	{ &asn_OER_type_reference_Beta_QPSK_List_constr_2, &asn_PER_type_reference_Beta_QPSK_List_constr_2, SEQUENCE_OF_constraint },
...
static const ber_tlv_tag_t asn_DEF_reference_Beta_16QAM_List_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_reference_Beta_16QAM_List_4 = {
	...
	{ &asn_OER_type_reference_Beta_16QAM_List_constr_4, &asn_PER_type_reference_Beta_16QAM_List_constr_4, SEQUENCE_OF_constraint },
	asn_MBR_reference_Beta_16QAM_List_4,
	1,	/* Single element */
	&asn_SPC_reference_Beta_16QAM_List_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_E_TFCS_Info_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E_TFCS_Info, reference_Beta_QPSK_List),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_reference_Beta_QPSK_List_2,
		0,
		{ &asn_OER_memb_reference_Beta_QPSK_List_constr_2, &asn_PER_memb_reference_Beta_QPSK_List_constr_2,  memb_reference_Beta_QPSK_List_constraint_1 },
		0, 0, /* No default value */
		"reference-Beta-QPSK-List"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct E_TFCS_Info, reference_Beta_16QAM_List),
		...
		0,
		{ &asn_OER_memb_reference_Beta_16QAM_List_constr_4, &asn_PER_memb_reference_Beta_16QAM_List_constr_4,  memb_reference_Beta_16QAM_List_constraint_1 },
		0, 0, /* No default value */
		"reference-Beta-16QAM-List"
		},
};
static const ber_tlv_tag_t asn_DEF_E_TFCS_Info_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_E_TFCS_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* reference-Beta-QPSK-List */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* reference-Beta-16QAM-List */
};
asn_SEQUENCE_specifics_t asn_SPC_E_TFCS_Info_specs_1 = {
