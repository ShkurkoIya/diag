...
static int
memb_tdd128_constraint_7(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static asn_oer_constraints_t asn_OER_type_hS_SCCH_SetConfiguration_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
static asn_per_constraints_t asn_PER_type_hS_SCCH_SetConfiguration_constr_11 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
...
static asn_oer_constraints_t asn_OER_memb_hS_SCCH_SetConfiguration_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
static asn_per_constraints_t asn_PER_memb_hS_SCCH_SetConfiguration_constr_11 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_tdd128_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
static asn_per_constraints_t asn_PER_type_tdd128_constr_13 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_tdd128_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
static asn_per_constraints_t asn_PER_memb_tdd128_constr_13 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_hS_SCCH_SetConfiguration_11 = {
	...
	{ &asn_OER_type_hS_SCCH_SetConfiguration_constr_11, &asn_PER_type_hS_SCCH_SetConfiguration_constr_11, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_tdd384_8[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HS_SCCH_Info__modeSpecificInfo__tdd__tdd384, hS_SCCH_SetConfiguration),
		...
		0,
		{ &asn_OER_memb_hS_SCCH_SetConfiguration_constr_11, &asn_PER_memb_hS_SCCH_SetConfiguration_constr_11,  memb_hS_SCCH_SetConfiguration_constraint_8 },
		0, 0, /* No default value */
		"hS-SCCH-SetConfiguration"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_tdd128_13 = {
	...
	{ &asn_OER_type_tdd128_constr_13, &asn_PER_type_tdd128_constr_13, SEQUENCE_OF_constraint },
	asn_MBR_tdd128_13,
	1,	/* Single element */
...
static asn_TYPE_member_t asn_MBR_tdd_7[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HS_SCCH_Info__modeSpecificInfo__tdd, choice.tdd128),
		...
		&asn_DEF_tdd128_13,
		0,
		{ &asn_OER_memb_tdd128_constr_13, &asn_PER_memb_tdd128_constr_13,  memb_tdd128_constraint_7 },
		0, 0, /* No default value */
		"tdd128"
		},
};
...
asn_TYPE_member_t asn_MBR_HS_SCCH_Info_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_HS_SCCH_Info_specs_1 = {
