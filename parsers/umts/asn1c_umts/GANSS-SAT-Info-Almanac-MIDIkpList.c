...
static asn_oer_constraints_t asn_OER_type_GANSS_SAT_Info_Almanac_MIDIkpList_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
asn_per_constraints_t asn_PER_type_GANSS_SAT_Info_Almanac_MIDIkpList_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_GANSS_SAT_Info_Almanac_MIDIkpList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static const ber_tlv_tag_t asn_DEF_GANSS_SAT_Info_Almanac_MIDIkpList_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_SET_OF_specifics_t asn_SPC_GANSS_SAT_Info_Almanac_MIDIkpList_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_GANSS_SAT_Info_Almanac_MIDIkpList = {
	...
	sizeof(asn_DEF_GANSS_SAT_Info_Almanac_MIDIkpList_tags_1)
		/sizeof(asn_DEF_GANSS_SAT_Info_Almanac_MIDIkpList_tags_1[0]), /* 1 */
	{ &asn_OER_type_GANSS_SAT_Info_Almanac_MIDIkpList_constr_1, &asn_PER_type_GANSS_SAT_Info_Almanac_MIDIkpList_constr_1, SEQUENCE_OF_constraint },
