...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_NAS_Synchronisation_Indicator_constr_1;
...
oer_type_decoder_f NAS_Synchronisation_Indicator_decode_oer;
oer_type_encoder_f NAS_Synchronisation_Indicator_encode_oer;
