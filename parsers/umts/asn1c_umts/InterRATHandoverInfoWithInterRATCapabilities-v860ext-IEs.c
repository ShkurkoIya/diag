...
asn_TYPE_member_t asn_MBR_InterRATHandoverInfoWithInterRATCapabilities_v860ext_IEs_1[] = {
...
static const int asn_MAP_InterRATHandoverInfoWithInterRATCapabilities_v860ext_IEs_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_InterRATHandoverInfoWithInterRATCapabilities_v860ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_InterRATHandoverInfoWithInterRATCapabilities_v860ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* ue-RATSpecificCapability */
};
asn_SEQUENCE_specifics_t asn_SPC_InterRATHandoverInfoWithInterRATCapabilities_v860ext_IEs_specs_1 = {
