...
asn_TYPE_member_t asn_MBR_RAB_InformationSetup_r8_1[] = {
...
static const int asn_MAP_RAB_InformationSetup_r8_oms_1[] = { 1, 2 };
static const ber_tlv_tag_t asn_DEF_RAB_InformationSetup_r8_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RAB_InformationSetup_r8_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_RAB_InformationSetup_r8_specs_1 = {
