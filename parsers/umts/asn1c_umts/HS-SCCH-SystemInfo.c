...
static int
memb_hS_SCCHChannelisationCodeInfo_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_hS_SCCHChannelisationCodeInfo_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
static asn_per_constraints_t asn_PER_type_hS_SCCHChannelisationCodeInfo_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_hS_SCCHChannelisationCodeInfo_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
static asn_per_constraints_t asn_PER_memb_hS_SCCHChannelisationCodeInfo_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_hS_SCCHChannelisationCodeInfo_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_hS_SCCHChannelisationCodeInfo_3 = {
	...
	{ &asn_OER_type_hS_SCCHChannelisationCodeInfo_constr_3, &asn_PER_type_hS_SCCHChannelisationCodeInfo_constr_3, SEQUENCE_OF_constraint },
	asn_MBR_hS_SCCHChannelisationCodeInfo_3,
	1,	/* Single element */
	&asn_SPC_hS_SCCHChannelisationCodeInfo_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_HS_SCCH_SystemInfo_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HS_SCCH_SystemInfo, hS_SCCHChannelisationCodeInfo),
		...
		0,
		{ &asn_OER_memb_hS_SCCHChannelisationCodeInfo_constr_3, &asn_PER_memb_hS_SCCHChannelisationCodeInfo_constr_3,  memb_hS_SCCHChannelisationCodeInfo_constraint_1 },
		0, 0, /* No default value */
		"hS-SCCHChannelisationCodeInfo"
		},
};
static const int asn_MAP_HS_SCCH_SystemInfo_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_HS_SCCH_SystemInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_HS_SCCH_SystemInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-ScramblingCode */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* hS-SCCHChannelisationCodeInfo */
};
asn_SEQUENCE_specifics_t asn_SPC_HS_SCCH_SystemInfo_specs_1 = {
