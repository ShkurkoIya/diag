...
static asn_oer_constraints_t asn_OER_type_UL_SecondaryCellInfoFDD_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_UL_SecondaryCellInfoFDD_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_UL_SecondaryCellInfoFDD_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_UL_SecondaryCellInfoFDD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* continue */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* newConfiguration */
};
asn_CHOICE_specifics_t asn_SPC_UL_SecondaryCellInfoFDD_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_UL_SecondaryCellInfoFDD = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_UL_SecondaryCellInfoFDD_constr_1, &asn_PER_type_UL_SecondaryCellInfoFDD_constr_1, CHOICE_constraint },
