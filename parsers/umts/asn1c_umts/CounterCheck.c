...
static asn_oer_constraints_t asn_OER_type_CounterCheck_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_CounterCheck_constr_1 CC_NOTUSED = {
...
asn_CHOICE_specifics_t asn_SPC_CounterCheck_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_CounterCheck = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_CounterCheck_constr_1, &asn_PER_type_CounterCheck_constr_1, CHOICE_constraint },
