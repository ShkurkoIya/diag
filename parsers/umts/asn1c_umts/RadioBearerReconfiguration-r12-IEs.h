...
#ifndef	_RadioBearerReconfiguration_r12_IEs_H_
#define	_RadioBearerReconfiguration_r12_IEs_H_
...
/* Dependencies */
typedef enum RadioBearerReconfiguration_r12_IEs__responseToChangeOfUE_Capability {
	RadioBearerReconfiguration_r12_IEs__responseToChangeOfUE_Capability_true	= 0
} e_RadioBearerReconfiguration_r12_IEs__responseToChangeOfUE_Capability;
typedef enum RadioBearerReconfiguration_r12_IEs__specificationMode_PR {
	RadioBearerReconfiguration_r12_IEs__specificationMode_PR_NOTHING,	/* No components present */
	RadioBearerReconfiguration_r12_IEs__specificationMode_PR_complete,
	RadioBearerReconfiguration_r12_IEs__specificationMode_PR_preconfiguration
} RadioBearerReconfiguration_r12_IEs__specificationMode_PR;
typedef enum RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration__preConfigMode_PR {
	RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration__preConfigMode_PR_NOTHING,	/* No components present */
	RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration__preConfigMode_PR_predefinedConfigIdentity,
	RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration__preConfigMode_PR_defaultConfig
} RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration__preConfigMode_PR;
...
struct UL_SecondaryCellInfoFDD_r12;
...
struct DL_InformationPerRL_List_r12;
...
typedef struct RadioBearerReconfiguration_r12_IEs {
	...
	struct RadioBearerReconfiguration_r12_IEs__specificationMode {
		RadioBearerReconfiguration_r12_IEs__specificationMode_PR present;
		union RadioBearerReconfiguration_r12_IEs__specificationMode_u {
			struct RadioBearerReconfiguration_r12_IEs__specificationMode__complete {
			...
			struct RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration {
				struct RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration__preConfigMode {
					RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration__preConfigMode_PR present;
					union RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration__preConfigMode_u {
						PredefinedConfigIdentity_t	 predefinedConfigIdentity;
						struct RadioBearerReconfiguration_r12_IEs__specificationMode__preconfiguration__preConfigMode__defaultConfig {
	...
	struct UL_SecondaryCellInfoFDD_r12	*ul_SecondaryCellInfoFDD	/* OPTIONAL */;
	...
	struct DL_InformationPerRL_List_r12	*dl_InformationPerRL_List	/* OPTIONAL */;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RadioBearerReconfiguration_r12_IEs_t;

/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_responseToChangeOfUE_Capability_19;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_RadioBearerReconfiguration_r12_IEs;
extern asn_SEQUENCE_specifics_t asn_SPC_RadioBearerReconfiguration_r12_IEs_specs_1;
extern asn_TYPE_member_t asn_MBR_RadioBearerReconfiguration_r12_IEs_1[52];
...
#include "UL-SecondaryCellInfoFDD-r12.h"
...
#endif	/* _RadioBearerReconfiguration_r12_IEs_H_ */
