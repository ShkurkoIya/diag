 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_securityRevertStatusIndicator_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_securityRevertStatusIndicator_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_loggedMeasAvailable_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_loggedMeasAvailable_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_loggedANRResultsAvailable_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_loggedANRResultsAvailable_constr_7 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_securityRevertStatusIndicator_value2enum_2[] = {
	{ 0,	12,	"revertedBack" },
	{ 1,	15,	"normalOperation" }
};
static const unsigned int asn_MAP_securityRevertStatusIndicator_enum2value_2[] = {
	1,	/* normalOperation(1) */
	0	/* revertedBack(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_securityRevertStatusIndicator_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_securityRevertStatusIndicator_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_securityRevertStatusIndicator_2 = {
	...
	{ &asn_OER_type_securityRevertStatusIndicator_constr_2, &asn_PER_type_securityRevertStatusIndicator_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_securityRevertStatusIndicator_specs_2	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_loggedMeasAvailable_value2enum_5[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_loggedMeasAvailable_enum2value_5[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_loggedMeasAvailable_specs_5 = {
...
static const ber_tlv_tag_t asn_DEF_loggedMeasAvailable_tags_5[] = {
...
asn_TYPE_descriptor_t asn_DEF_loggedMeasAvailable_5 = {
	...
	{ &asn_OER_type_loggedMeasAvailable_constr_5, &asn_PER_type_loggedMeasAvailable_constr_5, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_loggedMeasAvailable_specs_5	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_loggedANRResultsAvailable_value2enum_7[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_loggedANRResultsAvailable_enum2value_7[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_loggedANRResultsAvailable_specs_7 = {
...
static const ber_tlv_tag_t asn_DEF_loggedANRResultsAvailable_tags_7[] = {
...
asn_TYPE_descriptor_t asn_DEF_loggedANRResultsAvailable_7 = {
	...
	{ &asn_OER_type_loggedANRResultsAvailable_constr_7, &asn_PER_type_loggedANRResultsAvailable_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_loggedANRResultsAvailable_specs_7	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_CellUpdate_va40ext_IEs_1[] = {
...
static const int asn_MAP_CellUpdate_va40ext_IEs_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_CellUpdate_va40ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CellUpdate_va40ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* securityRevertStatusIndicator */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* loggedMeasAvailable */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* loggedANRResultsAvailable */
};
asn_SEQUENCE_specifics_t asn_SPC_CellUpdate_va40ext_IEs_specs_1 = {
