...
typedef enum LogicalChannelConfig__channelAccessPriority_r15_PR {
	LogicalChannelConfig__channelAccessPriority_r15_PR_NOTHING,	/* No components present */
	LogicalChannelConfig__channelAccessPriority_r15_PR_release,
	LogicalChannelConfig__channelAccessPriority_r15_PR_setup
} LogicalChannelConfig__channelAccessPriority_r15_PR;
...
typedef enum LogicalChannelConfig__allowedHARQ_Mode_r18 {
	LogicalChannelConfig__allowedHARQ_Mode_r18_harqModeA	= 0,
	LogicalChannelConfig__allowedHARQ_Mode_r18_harqModeB	= 1
} e_LogicalChannelConfig__allowedHARQ_Mode_r18;
...
typedef struct LogicalChannelConfig {
	...
	struct LogicalChannelConfig__channelAccessPriority_r15 {
		LogicalChannelConfig__channelAccessPriority_r15_PR present;
		union LogicalChannelConfig__channelAccessPriority_r15_u {
			NULL_t	 release;
			long	 setup;
		} choice;
	...
	long	*allowedHARQ_Mode_r18	/* OPTIONAL */;
...
/* extern asn_TYPE_descriptor_t asn_DEF_bitRateMultiplier_r16_59;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_allowedHARQ_Mode_r18_64;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_LogicalChannelConfig_1[11];
