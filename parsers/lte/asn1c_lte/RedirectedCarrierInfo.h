...
typedef enum RedirectedCarrierInfo_PR {
	...
	RedirectedCarrierInfo_PR_nr_r19,
	RedirectedCarrierInfo_PR_eutra_NTN_r19
...
typedef struct RedirectedCarrierInfo {
	...
	union RedirectedCarrierInfo_u {
		...
		CarrierInfoNR_r19_t	 nr_r19;
		CarrierInfoEUTRA_r19_t	 eutra_NTN_r19;
	} choice;
...
extern asn_TYPE_member_t asn_MBR_RedirectedCarrierInfo_1[11];
