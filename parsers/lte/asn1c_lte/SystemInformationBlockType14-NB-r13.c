...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType14_NB_r13_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType14_NB_r13, ab_PerNRSRP_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType14_NB_r13, uac_Param_r16),
...
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType14_NB_r13_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* uac-Param-r16 */
};
