...
static asn_oer_constraints_t asn_OER_type_subcarrierSpacingSSB_r17_constr_26 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_subcarrierSpacingSSB_r17_constr_26 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_subcarrierSpacingSSB_r16_3 = {
	...
	{ &asn_OER_type_subcarrierSpacingSSB_r16_constr_3, &asn_PER_type_subcarrierSpacingSSB_r16_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_reportQuantitiesNR_r16_10 = {
	...
	{ &asn_OER_type_reportQuantitiesNR_r16_constr_10, &asn_PER_type_reportQuantitiesNR_r16_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static const asn_INTEGER_enum_map_t asn_MAP_subcarrierSpacingSSB_r17_value2enum_26[] = {
	{ 0,	6,	"kHz480" },
	{ 1,	6,	"spare1" }
};
static const unsigned int asn_MAP_subcarrierSpacingSSB_r17_enum2value_26[] = {
	0,	/* kHz480(0) */
	1	/* spare1(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_subcarrierSpacingSSB_r17_specs_26 = {
	asn_MAP_subcarrierSpacingSSB_r17_value2enum_26,	/* "tag" => N; sorted by tag */
	asn_MAP_subcarrierSpacingSSB_r17_enum2value_26,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_subcarrierSpacingSSB_r17_tags_26[] = {
	(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_subcarrierSpacingSSB_r17_26 = {
	"subcarrierSpacingSSB-r17",
	"subcarrierSpacingSSB-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_subcarrierSpacingSSB_r17_tags_26,
	sizeof(asn_DEF_subcarrierSpacingSSB_r17_tags_26)
		/sizeof(asn_DEF_subcarrierSpacingSSB_r17_tags_26[0]) - 1, /* 1 */
	asn_DEF_subcarrierSpacingSSB_r17_tags_26,	/* Same as above */
	sizeof(asn_DEF_subcarrierSpacingSSB_r17_tags_26)
		/sizeof(asn_DEF_subcarrierSpacingSSB_r17_tags_26[0]), /* 2 */
	{ &asn_OER_type_subcarrierSpacingSSB_r17_constr_26, &asn_PER_type_subcarrierSpacingSSB_r17_constr_26, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_subcarrierSpacingSSB_r17_specs_26	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_MeasIdleCarrierNR_r16_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct MeasIdleCarrierNR_r16, subcarrierSpacingSSB_r17),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_subcarrierSpacingSSB_r17_26,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"subcarrierSpacingSSB-r17"
...
static const asn_TYPE_tag2member_t asn_MAP_MeasIdleCarrierNR_r16_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 } /* subcarrierSpacingSSB-r17 */
};
