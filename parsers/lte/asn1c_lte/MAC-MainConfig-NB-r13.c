...
asn_TYPE_member_t asn_MBR_MAC_MainConfig_NB_r13_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct MAC_MainConfig_NB_r13, logicalChannelSR_Config_r13),
	...
	{ ATF_POINTER, 5, offsetof(struct MAC_MainConfig_NB_r13, rai_Activation_r14),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct MAC_MainConfig_NB_r13, dataInactivityTimerConfig_r14),
	...
	{ ATF_POINTER, 3, offsetof(struct MAC_MainConfig_NB_r13, drx_Cycle_v1430),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct MAC_MainConfig_NB_r13, ra_CFRA_Config_r14),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct MAC_MainConfig_NB_r13, offsetThresholdTA_r17),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_4133P26,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
...
static const int asn_MAP_MAC_MainConfig_NB_r13_oms_1[] = { 0, 1, 3, 4, 5, 6, 7, 8 };
...
static const asn_TYPE_tag2member_t asn_MAP_MAC_MainConfig_NB_r13_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 } /* offsetThresholdTA-r17 */
};
