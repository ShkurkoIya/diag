...
static asn_oer_constraints_t asn_OER_type_sharedSpectrumMeasNR_EN_DC_r17_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..1024)) */};
...
static asn_oer_constraints_t asn_OER_type_sharedSpectrumMeasNR_SA_r17_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..1024)) */};
...
static asn_oer_constraints_t asn_OER_memb_sharedSpectrumMeasNR_EN_DC_r17_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..1024)) */};
...
static asn_oer_constraints_t asn_OER_memb_sharedSpectrumMeasNR_SA_r17_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..1024)) */};
...
asn_TYPE_descriptor_t asn_DEF_sharedSpectrumMeasNR_EN_DC_r17_2 = {
	...
	{ &asn_OER_type_sharedSpectrumMeasNR_EN_DC_r17_constr_2, &asn_PER_type_sharedSpectrumMeasNR_EN_DC_r17_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_sharedSpectrumMeasNR_SA_r17_4 = {
	...
	{ &asn_OER_type_sharedSpectrumMeasNR_SA_r17_constr_4, &asn_PER_type_sharedSpectrumMeasNR_SA_r17_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_MeasParameters_v1700_1[] = {
	{ ATF_POINTER, 2, offsetof(struct MeasParameters_v1700, sharedSpectrumMeasNR_EN_DC_r17),
		...
		0,
		{ &asn_OER_memb_sharedSpectrumMeasNR_EN_DC_r17_constr_2, &asn_PER_memb_sharedSpectrumMeasNR_EN_DC_r17_constr_2,  memb_sharedSpectrumMeasNR_EN_DC_r17_constraint_1 },
		0, 0, /* No default value */
		"sharedSpectrumMeasNR-EN-DC-r17"
		},
	{ ATF_POINTER, 1, offsetof(struct MeasParameters_v1700, sharedSpectrumMeasNR_SA_r17),
		...
		0,
		{ &asn_OER_memb_sharedSpectrumMeasNR_SA_r17_constr_4, &asn_PER_memb_sharedSpectrumMeasNR_SA_r17_constr_4,  memb_sharedSpectrumMeasNR_SA_r17_constraint_1 },
		0, 0, /* No default value */
		"sharedSpectrumMeasNR-SA-r17"
		},
};
