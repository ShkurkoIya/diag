...
static asn_TYPE_member_t asn_MBR_later_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionResumeRequest_NB__criticalExtensions__later, choice.rrcConnectionResumeRequest_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionResumeRequest_NB__criticalExtensions__later, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionResumeRequest_NB__criticalExtensions, choice.later),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
