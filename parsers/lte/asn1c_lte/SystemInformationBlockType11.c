...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType11_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType11, dataCodingScheme),
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType11, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType11, warningAreaCoordinatesSegment_r19),
...
static const int asn_MAP_SystemInformationBlockType11_oms_1[] = { 5, 6, 7 };
...
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType11_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* warningAreaCoordinatesSegment-r19 */
};
