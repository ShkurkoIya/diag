...
typedef enum MasterInformationBlock_NB__partEARFCN_r17_PR {
	MasterInformationBlock_NB__partEARFCN_r17_PR_NOTHING,	/* No components present */
	MasterInformationBlock_NB__partEARFCN_r17_PR_spare,
	MasterInformationBlock_NB__partEARFCN_r17_PR_earfcn_LSB
} MasterInformationBlock_NB__partEARFCN_r17_PR;
...
typedef struct MasterInformationBlock_NB {
	...
	struct MasterInformationBlock_NB__partEARFCN_r17 {
		MasterInformationBlock_NB__partEARFCN_r17_PR present;
		union MasterInformationBlock_NB__partEARFCN_r17_u {
			BIT_STRING_t	 spare;
...
extern asn_TYPE_member_t asn_MBR_MasterInformationBlock_NB_1[10];
