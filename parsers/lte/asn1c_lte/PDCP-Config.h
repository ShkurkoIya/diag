...
typedef struct PDCP_Config {
	...
	struct SetupRelease	*ethernetHeaderCompression_r16	/* OPTIONAL */;
	struct SetupRelease	*discardTimerExt_r17	/* OPTIONAL */;
...
extern asn_TYPE_member_t asn_MBR_PDCP_Config_1[17];
