...
static int
memb_spare_constraint_14(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_earfcn_LSB_constraint_14(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_oer_constraints_t asn_OER_memb_earfcn_LSB_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	2	/* (SIZE(2..2)) */};
static asn_per_constraints_t asn_PER_memb_earfcn_LSB_constr_16 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  2,  2 }	/* (SIZE(2..2)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_partEARFCN_r17_constr_14 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_partEARFCN_r17_constr_14 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_partEARFCN_r17_14[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_NB__partEARFCN_r17, choice.spare),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_spare_constr_15, &asn_PER_memb_spare_constr_15,  memb_spare_constraint_14 },
		0, 0, /* No default value */
		"spare"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_NB__partEARFCN_r17, choice.earfcn_LSB),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_earfcn_LSB_constr_16, &asn_PER_memb_earfcn_LSB_constr_16,  memb_earfcn_LSB_constraint_14 },
		0, 0, /* No default value */
		"earfcn-LSB"
		},
};
static const asn_TYPE_tag2member_t asn_MAP_partEARFCN_r17_tag2el_14[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* spare */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* earfcn-LSB */
};
static asn_CHOICE_specifics_t asn_SPC_partEARFCN_r17_specs_14 = {
	sizeof(struct MasterInformationBlock_NB__partEARFCN_r17),
	offsetof(struct MasterInformationBlock_NB__partEARFCN_r17, _asn_ctx),
	offsetof(struct MasterInformationBlock_NB__partEARFCN_r17, present),
	sizeof(((struct MasterInformationBlock_NB__partEARFCN_r17 *)0)->present),
	asn_MAP_partEARFCN_r17_tag2el_14,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_partEARFCN_r17_14 = {
	"partEARFCN-r17",
	"partEARFCN-r17",
	&asn_OP_CHOICE,
	0,	/* No effective tags (pointer) */
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_partEARFCN_r17_constr_14, &asn_PER_type_partEARFCN_r17_constr_14, CHOICE_constraint },
	asn_MBR_partEARFCN_r17_14,
	2,	/* Elements count */
	&asn_SPC_partEARFCN_r17_specs_14	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_MasterInformationBlock_NB_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_NB, partEARFCN_r17),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_partEARFCN_r17_14,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"partEARFCN-r17"
...
static const asn_TYPE_tag2member_t asn_MAP_MasterInformationBlock_NB_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* partEARFCN-r17 */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 } /* spare */
};
