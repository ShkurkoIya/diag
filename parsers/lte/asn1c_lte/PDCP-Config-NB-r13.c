...
static asn_oer_constraints_t asn_OER_type_cipheringDisabled_r16_constr_25 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_cipheringDisabled_r16_constr_25 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_cipheringDisabled_r16_value2enum_25[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_cipheringDisabled_r16_enum2value_25[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_cipheringDisabled_r16_specs_25 = {
	asn_MAP_cipheringDisabled_r16_value2enum_25,	/* "tag" => N; sorted by tag */
	asn_MAP_cipheringDisabled_r16_enum2value_25,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_cipheringDisabled_r16_tags_25[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_cipheringDisabled_r16_25 = {
	"cipheringDisabled-r16",
	"cipheringDisabled-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_cipheringDisabled_r16_tags_25,
	sizeof(asn_DEF_cipheringDisabled_r16_tags_25)
		/sizeof(asn_DEF_cipheringDisabled_r16_tags_25[0]) - 1, /* 1 */
	asn_DEF_cipheringDisabled_r16_tags_25,	/* Same as above */
	sizeof(asn_DEF_cipheringDisabled_r16_tags_25)
		/sizeof(asn_DEF_cipheringDisabled_r16_tags_25[0]), /* 2 */
	{ &asn_OER_type_cipheringDisabled_r16_constr_25, &asn_PER_type_cipheringDisabled_r16_constr_25, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_cipheringDisabled_r16_specs_25	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_PDCP_Config_NB_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PDCP_Config_NB_r13, cipheringDisabled_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_cipheringDisabled_r16_25,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"cipheringDisabled-r16"
...
static const asn_TYPE_tag2member_t asn_MAP_PDCP_Config_NB_r13_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* cipheringDisabled-r16 */
};
