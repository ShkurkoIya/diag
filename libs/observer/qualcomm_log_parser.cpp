...
QualcommLogParser::QualcommLogParser() {
    ...
    gsm_.set_cell_callback([this](const GsmCell &) { fire_neighbor_update(); });
    wcdma_.set_cell_callback([this](const WcdmaCell &) { fire_neighbor_update(); });
    nr_.set_cell_callback([this](const NrCell &) { fire_neighbor_update(); });
