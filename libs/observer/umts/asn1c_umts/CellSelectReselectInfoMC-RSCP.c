...
asn_TYPE_member_t asn_MBR_CellSelectReselectInfoMC_RSCP_1[] = {
...
static const int asn_MAP_CellSelectReselectInfoMC_RSCP_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_CellSelectReselectInfoMC_RSCP_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CellSelectReselectInfoMC_RSCP_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_CellSelectReselectInfoMC_RSCP_specs_1 = {
