...
extern asn_SEQUENCE_specifics_t asn_SPC_LoggedMeasurementsConfigurationInfo_specs_1;
extern asn_TYPE_member_t asn_MBR_LoggedMeasurementsConfigurationInfo_1[7];
