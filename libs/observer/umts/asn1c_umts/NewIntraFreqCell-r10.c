...
static int
memb_sNPLMonitorSetIndicator_TDD128_constraint_6(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_sNPLMonitorSetIndicator_TDD128_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	5	/* (SIZE(5..5)) */};
static asn_per_constraints_t asn_PER_memb_sNPLMonitorSetIndicator_TDD128_constr_7 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_tdd128_6[] = {
	{ ATF_POINTER, 1, offsetof(struct NewIntraFreqCell_r10__modeSpecificInfo__tdd128, sNPLMonitorSetIndicator_TDD128),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_sNPLMonitorSetIndicator_TDD128_constr_7, &asn_PER_memb_sNPLMonitorSetIndicator_TDD128_constr_7,  memb_sNPLMonitorSetIndicator_TDD128_constraint_6 },
...
static const asn_TYPE_tag2member_t asn_MAP_tdd128_tag2el_6[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* sNPLMonitorSetIndicator-TDD128 */
};
...
asn_TYPE_member_t asn_MBR_NewIntraFreqCell_r10_1[] = {
...
static const int asn_MAP_NewIntraFreqCell_r10_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_NewIntraFreqCell_r10_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NewIntraFreqCell_r10_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_NewIntraFreqCell_r10_specs_1 = {
