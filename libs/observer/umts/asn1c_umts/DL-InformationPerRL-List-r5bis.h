...
typedef struct DL_InformationPerRL_List_r5bis {
    A_SEQUENCE_OF(struct DL_InformationPerRL_r5bis)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_DL_InformationPerRL_List_r5bis_specs_1;
extern asn_TYPE_member_t asn_MBR_DL_InformationPerRL_List_r5bis_1[1];
extern asn_per_constraints_t asn_PER_type_DL_InformationPerRL_List_r5bis_constr_1;
