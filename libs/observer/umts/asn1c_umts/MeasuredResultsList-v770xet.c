...
static asn_oer_constraints_t asn_OER_type_MeasuredResultsList_v770xet_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
asn_per_constraints_t asn_PER_type_MeasuredResultsList_v770xet_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_MeasuredResultsList_v770xet_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_Member_2,
...
static const ber_tlv_tag_t asn_DEF_MeasuredResultsList_v770xet_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_SET_OF_specifics_t asn_SPC_MeasuredResultsList_v770xet_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_MeasuredResultsList_v770xet = {
	...
	sizeof(asn_DEF_MeasuredResultsList_v770xet_tags_1)
		/sizeof(asn_DEF_MeasuredResultsList_v770xet_tags_1[0]), /* 1 */
	{ &asn_OER_type_MeasuredResultsList_v770xet_constr_1, &asn_PER_type_MeasuredResultsList_v770xet_constr_1, SEQUENCE_OF_constraint },
