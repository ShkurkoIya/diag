...
typedef struct MBMS_SelectedServicesListFull {
    A_SEQUENCE_OF(struct MBMS_ServiceIdentity_r6)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_MBMS_SelectedServicesListFull_specs_1;
extern asn_TYPE_member_t asn_MBR_MBMS_SelectedServicesListFull_1[1];
extern asn_per_constraints_t asn_PER_type_MBMS_SelectedServicesListFull_constr_1;
