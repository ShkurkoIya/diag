...
typedef struct UE_RadioAccessCapabBandFDDList3 {
    A_SEQUENCE_OF(struct UE_RadioAccessCapabBandFDD3)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_UE_RadioAccessCapabBandFDDList3_specs_1;
extern asn_TYPE_member_t asn_MBR_UE_RadioAccessCapabBandFDDList3_1[1];
extern asn_per_constraints_t asn_PER_type_UE_RadioAccessCapabBandFDDList3_constr_1;
