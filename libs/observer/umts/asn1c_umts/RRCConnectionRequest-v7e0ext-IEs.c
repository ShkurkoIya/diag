 ...
 */
static asn_oer_constraints_t asn_OER_type_supportForCSVoiceoverHSPA_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_supportForCSVoiceoverHSPA_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_supportForCSVoiceoverHSPA_value2enum_2[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_supportForCSVoiceoverHSPA_enum2value_2[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_supportForCSVoiceoverHSPA_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_supportForCSVoiceoverHSPA_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_supportForCSVoiceoverHSPA_2 = {
	...
	{ &asn_OER_type_supportForCSVoiceoverHSPA_constr_2, &asn_PER_type_supportForCSVoiceoverHSPA_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_supportForCSVoiceoverHSPA_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_RRCConnectionRequest_v7e0ext_IEs_1[] = {
...
static const int asn_MAP_RRCConnectionRequest_v7e0ext_IEs_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_RRCConnectionRequest_v7e0ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RRCConnectionRequest_v7e0ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* supportForCSVoiceoverHSPA */
};
asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionRequest_v7e0ext_IEs_specs_1 = {
