...
typedef struct MBSFN_InterFrequencyNeighbourList_v860ext {
    A_SEQUENCE_OF(struct MBSFNInterFrequencyNeighbour_v860ext)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_MBSFN_InterFrequencyNeighbourList_v860ext_specs_1;
extern asn_TYPE_member_t asn_MBR_MBSFN_InterFrequencyNeighbourList_v860ext_1[1];
extern asn_per_constraints_t asn_PER_type_MBSFN_InterFrequencyNeighbourList_v860ext_constr_1;
