...
static asn_oer_constraints_t asn_OER_type_tdd384_hspdsch_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_tdd384_hspdsch_constr_7 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_tdd384_hspdsch_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_tdd384_hspdsch_constr_7, &asn_PER_type_tdd384_hspdsch_constr_7, CHOICE_constraint },
	asn_MBR_tdd384_hspdsch_7,
	2,	/* Elements count */
	&asn_SPC_tdd384_hspdsch_specs_7	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_DL_PhysChCapabilityTDD_r5_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_DL_PhysChCapabilityTDD_r5_specs_1 = {
