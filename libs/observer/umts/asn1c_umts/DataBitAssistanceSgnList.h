...
typedef struct DataBitAssistanceSgnList {
    A_SEQUENCE_OF(struct DataBitAssistance)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_DataBitAssistanceSgnList_specs_1;
extern asn_TYPE_member_t asn_MBR_DataBitAssistanceSgnList_1[1];
extern asn_per_constraints_t asn_PER_type_DataBitAssistanceSgnList_constr_1;
