...
extern asn_SEQUENCE_specifics_t asn_SPC_RadioBearerReconfigurationFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RadioBearerReconfigurationFailure_1[4];
