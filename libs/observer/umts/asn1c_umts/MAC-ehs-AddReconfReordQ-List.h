...
typedef struct MAC_ehs_AddReconfReordQ_List {
    A_SEQUENCE_OF(struct MAC_ehs_AddReconfReordQ)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_MAC_ehs_AddReconfReordQ_List_specs_1;
extern asn_TYPE_member_t asn_MBR_MAC_ehs_AddReconfReordQ_List_1[1];
extern asn_per_constraints_t asn_PER_type_MAC_ehs_AddReconfReordQ_List_constr_1;
