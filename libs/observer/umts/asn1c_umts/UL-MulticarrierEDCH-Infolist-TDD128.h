...
typedef struct UL_MulticarrierEDCH_Infolist_TDD128 {
    A_SEQUENCE_OF(struct UL_MulticarrierEDCH_InfolistItem_TDD128)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_UL_MulticarrierEDCH_Infolist_TDD128_specs_1;
extern asn_TYPE_member_t asn_MBR_UL_MulticarrierEDCH_Infolist_TDD128_1[1];
extern asn_per_constraints_t asn_PER_type_UL_MulticarrierEDCH_Infolist_TDD128_constr_1;
