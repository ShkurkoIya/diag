...
static int
memb_tm_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_tm_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (0..38399) */,
	-1};
static asn_per_constraints_t asn_PER_memb_tm_constr_5 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_fdd_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellSynchronisationInfo__modeSpecificInfo__fdd, tm),
		...
		0,
		{ &asn_OER_memb_tm_constr_5, &asn_PER_memb_tm_constr_5,  memb_tm_constraint_3 },
		0, 0, /* No default value */
		"tm"
		},
};
...
asn_TYPE_member_t asn_MBR_CellSynchronisationInfo_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_CellSynchronisationInfo_specs_1 = {
