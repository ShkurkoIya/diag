...
typedef struct SystemSpecificCapUpdateReqList_r8 {
    A_SEQUENCE_OF(SystemSpecificCapUpdateReq_r8_t)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_SystemSpecificCapUpdateReqList_r8_specs_1;
extern asn_TYPE_member_t asn_MBR_SystemSpecificCapUpdateReqList_r8_1[1];
extern asn_per_constraints_t asn_PER_type_SystemSpecificCapUpdateReqList_r8_constr_1;
