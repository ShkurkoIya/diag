...
typedef struct RB_PDCPContextRelocationList {
    A_SEQUENCE_OF(struct RB_PDCPContextRelocation)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_RB_PDCPContextRelocationList_specs_1;
extern asn_TYPE_member_t asn_MBR_RB_PDCPContextRelocationList_1[1];
extern asn_per_constraints_t asn_PER_type_RB_PDCPContextRelocationList_constr_1;
