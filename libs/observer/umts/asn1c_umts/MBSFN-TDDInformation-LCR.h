...
typedef struct MBSFN_TDDInformation_LCR {
    A_SEQUENCE_OF(struct MBSFN_TDDTimeSlotInfo_LCR)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_MBSFN_TDDInformation_LCR_specs_1;
extern asn_TYPE_member_t asn_MBR_MBSFN_TDDInformation_LCR_1[1];
extern asn_per_constraints_t asn_PER_type_MBSFN_TDDInformation_LCR_constr_1;
