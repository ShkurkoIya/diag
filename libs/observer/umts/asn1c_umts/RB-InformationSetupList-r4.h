...
typedef struct RB_InformationSetupList_r4 {
    A_SEQUENCE_OF(struct RB_InformationSetup_r4)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_RB_InformationSetupList_r4_specs_1;
extern asn_TYPE_member_t asn_MBR_RB_InformationSetupList_r4_1[1];
extern asn_per_constraints_t asn_PER_type_RB_InformationSetupList_r4_constr_1;
