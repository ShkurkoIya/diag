...
asn_TYPE_member_t asn_MBR_E_DCH_RL_InfoNewSecServingCell_1[] = {
...
static const int asn_MAP_E_DCH_RL_InfoNewSecServingCell_oms_1[] = { 1, 2 };
static const ber_tlv_tag_t asn_DEF_E_DCH_RL_InfoNewSecServingCell_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_E_DCH_RL_InfoNewSecServingCell_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* e-AGCH-Information */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* e-HICH-Information */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* e-RGCH-Info */
};
asn_SEQUENCE_specifics_t asn_SPC_E_DCH_RL_InfoNewSecServingCell_specs_1 = {
