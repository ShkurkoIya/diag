...
typedef struct MultiflowCapabBandCombList {
    A_SEQUENCE_OF(struct MultiflowCapabBandCombination)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_MultiflowCapabBandCombList_specs_1;
extern asn_TYPE_member_t asn_MBR_MultiflowCapabBandCombList_1[1];
extern asn_per_constraints_t asn_PER_type_MultiflowCapabBandCombList_constr_1;
