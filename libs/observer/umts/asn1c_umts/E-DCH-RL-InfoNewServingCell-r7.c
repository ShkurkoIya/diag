...
static asn_oer_constraints_t asn_OER_type_primary_Secondary_GrantSelector_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_primary_Secondary_GrantSelector_constr_6 CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_powerOffsetForSchedInfo_constr_11 CC_NOTUSED = {
	{ 1, 1 }	/* (0..6) */,
	-1};
static asn_per_constraints_t asn_PER_memb_powerOffsetForSchedInfo_constr_11 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  6 }	/* (0..6) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_threeIndexStepThreshold_constr_12 CC_NOTUSED = {
	{ 1, 1 }	/* (0..37) */,
	-1};
static asn_per_constraints_t asn_PER_memb_threeIndexStepThreshold_constr_12 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  37 }	/* (0..37) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_twoIndexStepThreshold_constr_13 CC_NOTUSED = {
	{ 1, 1 }	/* (0..37) */,
	-1};
static asn_per_constraints_t asn_PER_memb_twoIndexStepThreshold_constr_13 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  37 }	/* (0..37) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_primary_Secondary_GrantSelector_6 = {
	...
	{ &asn_OER_type_primary_Secondary_GrantSelector_constr_6, &asn_PER_type_primary_Secondary_GrantSelector_constr_6, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_servingGrant_4[] = {
	{ ATF_POINTER, 1, offsetof(struct E_DCH_RL_InfoNewServingCell_r7__servingGrant, value),
		...
		0,
		{ &asn_OER_memb_value_constr_5, &asn_PER_memb_value_constr_5,  memb_value_constraint_4 },
...
asn_TYPE_member_t asn_MBR_E_DCH_RL_InfoNewServingCell_r7_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct E_DCH_RL_InfoNewServingCell_r7, powerOffsetForSchedInfo),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_powerOffsetForSchedInfo_constr_11, &asn_PER_memb_powerOffsetForSchedInfo_constr_11,  memb_powerOffsetForSchedInfo_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 4, offsetof(struct E_DCH_RL_InfoNewServingCell_r7, threeIndexStepThreshold),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_threeIndexStepThreshold_constr_12, &asn_PER_memb_threeIndexStepThreshold_constr_12,  memb_threeIndexStepThreshold_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct E_DCH_RL_InfoNewServingCell_r7, twoIndexStepThreshold),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_twoIndexStepThreshold_constr_13, &asn_PER_memb_twoIndexStepThreshold_constr_13,  memb_twoIndexStepThreshold_constraint_1 },
		0, 0, /* No default value */
...
static const int asn_MAP_E_DCH_RL_InfoNewServingCell_r7_oms_1[] = { 2, 3, 4, 5, 6, 7, 8, 9 };
static const ber_tlv_tag_t asn_DEF_E_DCH_RL_InfoNewServingCell_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_E_DCH_RL_InfoNewServingCell_r7_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_E_DCH_RL_InfoNewServingCell_r7_specs_1 = {
