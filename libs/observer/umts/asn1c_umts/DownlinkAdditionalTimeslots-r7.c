...
asn_TYPE_member_t asn_MBR_DownlinkAdditionalTimeslots_r7_1[] = {
...
static const ber_tlv_tag_t asn_DEF_DownlinkAdditionalTimeslots_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DownlinkAdditionalTimeslots_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* parameters */
};
asn_SEQUENCE_specifics_t asn_SPC_DownlinkAdditionalTimeslots_r7_specs_1 = {
