...
static asn_oer_constraints_t asn_OER_type_UE_InternalEventParam_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_UE_InternalEventParam_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  6 }	/* (0..6) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_UE_InternalEventParam_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_UE_InternalEventParam_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_UE_InternalEventParam = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_UE_InternalEventParam_constr_1, &asn_PER_type_UE_InternalEventParam_constr_1, CHOICE_constraint },
