...
static asn_oer_constraints_t asn_OER_type_routingbasis_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_routingbasis_constr_2 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_routingbasis_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_routingbasis_constr_2, &asn_PER_type_routingbasis_constr_2, CHOICE_constraint },
	asn_MBR_routingbasis_2,
	8,	/* Elements count */
	&asn_SPC_routingbasis_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_Gsm_map_IDNNS_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_Gsm_map_IDNNS_specs_1 = {
