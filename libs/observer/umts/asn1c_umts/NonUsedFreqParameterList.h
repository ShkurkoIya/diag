...
typedef struct NonUsedFreqParameterList {
    A_SEQUENCE_OF(struct NonUsedFreqParameter)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_NonUsedFreqParameterList_specs_1;
extern asn_TYPE_member_t asn_MBR_NonUsedFreqParameterList_1[1];
extern asn_per_constraints_t asn_PER_type_NonUsedFreqParameterList_constr_1;
