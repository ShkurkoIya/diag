...
typedef struct E_RGCH_CombinationInfoList {
    A_SEQUENCE_OF(struct E_RGCH_Combination_Info)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_E_RGCH_CombinationInfoList_specs_1;
extern asn_TYPE_member_t asn_MBR_E_RGCH_CombinationInfoList_1[1];
extern asn_per_constraints_t asn_PER_type_E_RGCH_CombinationInfoList_constr_1;
