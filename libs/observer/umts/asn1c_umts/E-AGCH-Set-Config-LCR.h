...
typedef struct E_AGCH_Set_Config_LCR {
    A_SEQUENCE_OF(struct E_AGCH_Individual_LCR)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_E_AGCH_Set_Config_LCR_specs_1;
extern asn_TYPE_member_t asn_MBR_E_AGCH_Set_Config_LCR_1[1];
extern asn_per_constraints_t asn_PER_type_E_AGCH_Set_Config_LCR_constr_1;
