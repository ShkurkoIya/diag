...
extern asn_SEQUENCE_specifics_t asn_SPC_UTRAN_DRX_CycleLengthCoefficient_r7_specs_1;
extern asn_TYPE_member_t asn_MBR_UTRAN_DRX_CycleLengthCoefficient_r7_1[3];
