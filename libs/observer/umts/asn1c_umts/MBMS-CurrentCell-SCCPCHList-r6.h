...
typedef struct MBMS_CurrentCell_SCCPCHList_r6 {
    A_SEQUENCE_OF(struct MBMS_CurrentCell_SCCPCH_r6)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_MBMS_CurrentCell_SCCPCHList_r6_specs_1;
extern asn_TYPE_member_t asn_MBR_MBMS_CurrentCell_SCCPCHList_r6_1[1];
extern asn_per_constraints_t asn_PER_type_MBMS_CurrentCell_SCCPCHList_r6_constr_1;
