 ...
 */
static asn_oer_constraints_t asn_OER_type_supportOfMimoOnlySingleStream_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_supportOfMimoOnlySingleStream_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_supportOfMimoOnlySingleStream_value2enum_3[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_supportOfMimoOnlySingleStream_enum2value_3[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_supportOfMimoOnlySingleStream_specs_3 = {
...
static const ber_tlv_tag_t asn_DEF_supportOfMimoOnlySingleStream_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_supportOfMimoOnlySingleStream_3 = {
	...
	{ &asn_OER_type_supportOfMimoOnlySingleStream_constr_3, &asn_PER_type_supportOfMimoOnlySingleStream_constr_3, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_supportOfMimoOnlySingleStream_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_DL_PhysChCapabilityFDD_v920ext_1[] = {
...
static const int asn_MAP_DL_PhysChCapabilityFDD_v920ext_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_DL_PhysChCapabilityFDD_v920ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DL_PhysChCapabilityFDD_v920ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* hsdsch-physical-layer-category-ext3 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* supportOfMimoOnlySingleStream */
};
asn_SEQUENCE_specifics_t asn_SPC_DL_PhysChCapabilityFDD_v920ext_specs_1 = {
