...
static const int asn_MAP_v820NonCriticalExtensions_oms_12[] = { 1 };
static const ber_tlv_tag_t asn_DEF_v820NonCriticalExtensions_tags_12[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_v820NonCriticalExtensions_tag2el_12[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* transportformatcombinationcontrol-v820ext */
...
asn_TYPE_member_t asn_MBR_TransportFormatCombinationControl_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_TransportFormatCombinationControl_specs_1 = {
