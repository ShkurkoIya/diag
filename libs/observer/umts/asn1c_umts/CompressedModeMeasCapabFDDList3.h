...
typedef struct CompressedModeMeasCapabFDDList3 {
    A_SEQUENCE_OF(struct CompressedModeMeasCapabFDD3)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_CompressedModeMeasCapabFDDList3_specs_1;
extern asn_TYPE_member_t asn_MBR_CompressedModeMeasCapabFDDList3_1[1];
extern asn_per_constraints_t asn_PER_type_CompressedModeMeasCapabFDDList3_constr_1;
