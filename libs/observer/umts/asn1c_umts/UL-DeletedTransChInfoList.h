...
typedef struct UL_DeletedTransChInfoList {
    A_SEQUENCE_OF(struct UL_TransportChannelIdentity)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_UL_DeletedTransChInfoList_specs_1;
extern asn_TYPE_member_t asn_MBR_UL_DeletedTransChInfoList_1[1];
extern asn_per_constraints_t asn_PER_type_UL_DeletedTransChInfoList_constr_1;
