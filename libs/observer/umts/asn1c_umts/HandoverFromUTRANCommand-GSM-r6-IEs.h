...
extern asn_SEQUENCE_specifics_t asn_SPC_HandoverFromUTRANCommand_GSM_r6_IEs_specs_1;
extern asn_TYPE_member_t asn_MBR_HandoverFromUTRANCommand_GSM_r6_IEs_1[5];
