...
typedef struct LoggedANRReportInfoList_vb50ext {
    A_SEQUENCE_OF(struct LoggedANRReportInfo_vb50ext)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_LoggedANRReportInfoList_vb50ext_specs_1;
extern asn_TYPE_member_t asn_MBR_LoggedANRReportInfoList_vb50ext_1[1];
extern asn_per_constraints_t asn_PER_type_LoggedANRReportInfoList_vb50ext_constr_1;
