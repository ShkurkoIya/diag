...
asn_TYPE_member_t asn_MBR_DL_PhysChCapabilityInfoTDD_768_1[] = {
...
static const ber_tlv_tag_t asn_DEF_DL_PhysChCapabilityInfoTDD_768_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DL_PhysChCapabilityInfoTDD_768_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_DL_PhysChCapabilityInfoTDD_768_specs_1 = {
