...
typedef struct EUTRA_FrequencyAndPriorityInfoList_v920ext {
    A_SEQUENCE_OF(struct EUTRA_FrequencyAndPriorityInfo_v920ext)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_EUTRA_FrequencyAndPriorityInfoList_v920ext_specs_1;
extern asn_TYPE_member_t asn_MBR_EUTRA_FrequencyAndPriorityInfoList_v920ext_1[1];
extern asn_per_constraints_t asn_PER_type_EUTRA_FrequencyAndPriorityInfoList_v920ext_constr_1;
