...
asn_TYPE_member_t asn_MBR_DTX_E_DCH_TTI_10ms_1[] = {
...
static const ber_tlv_tag_t asn_DEF_DTX_E_DCH_TTI_10ms_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DTX_E_DCH_TTI_10ms_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-dtx-Cycle1-10ms */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ue-dtx-Cycle2-10ms */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* mac-dtx-Cycle-10ms */
};
asn_SEQUENCE_specifics_t asn_SPC_DTX_E_DCH_TTI_10ms_specs_1 = {
