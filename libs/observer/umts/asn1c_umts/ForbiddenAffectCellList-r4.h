...
typedef struct ForbiddenAffectCellList_r4 {
    A_SEQUENCE_OF(struct ForbiddenAffectCell_r4)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_ForbiddenAffectCellList_r4_specs_1;
extern asn_TYPE_member_t asn_MBR_ForbiddenAffectCellList_r4_1[1];
extern asn_per_constraints_t asn_PER_type_ForbiddenAffectCellList_r4_constr_1;
