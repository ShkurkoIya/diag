...
static int
memb_ims_Information_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
static asn_oer_constraints_t asn_OER_memb_ims_Information_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
static asn_per_constraints_t asn_PER_memb_ims_Information_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RSR_VCC_Info_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RSR_VCC_Info, ims_Information),
		...
		0,
		{ &asn_OER_memb_ims_Information_constr_3, &asn_PER_memb_ims_Information_constr_3,  memb_ims_Information_constraint_1 },
		0, 0, /* No default value */
		"ims-Information"
		},
};
static const int asn_MAP_RSR_VCC_Info_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_RSR_VCC_Info_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RSR_VCC_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nonce */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ims-Information */
};
asn_SEQUENCE_specifics_t asn_SPC_RSR_VCC_Info_specs_1 = {
