...
typedef struct TrafficVolumeMeasuredResultsList {
    A_SEQUENCE_OF(struct TrafficVolumeMeasuredResults)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_TrafficVolumeMeasuredResultsList_specs_1;
extern asn_TYPE_member_t asn_MBR_TrafficVolumeMeasuredResultsList_1[1];
extern asn_per_constraints_t asn_PER_type_TrafficVolumeMeasuredResultsList_constr_1;
