...
typedef enum CellUpdateFDD_r11__applicationLayerMeasurementReportAvailable {
    CellUpdateFDD_r11__applicationLayerMeasurementReportAvailable_true = 0
} e_CellUpdateFDD_r11__applicationLayerMeasurementReportAvailable;
...
typedef struct CellUpdateFDD_r11 {
    ...
    long *applicationLayerMeasurementReportAvailable /* OPTIONAL */;
...
/* extern asn_TYPE_descriptor_t asn_DEF_applicationLayerMeasurementReportAvailable_33;	// (Use -fall-defs-global to expose) */
...
extern asn_SEQUENCE_specifics_t asn_SPC_CellUpdateFDD_r11_specs_1;
extern asn_TYPE_member_t asn_MBR_CellUpdateFDD_r11_1[25];
