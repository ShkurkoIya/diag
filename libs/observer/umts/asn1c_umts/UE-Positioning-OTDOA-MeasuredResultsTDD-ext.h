...
extern asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_OTDOA_MeasuredResultsTDD_ext_specs_1;
extern asn_TYPE_member_t asn_MBR_UE_Positioning_OTDOA_MeasuredResultsTDD_ext_1[1];
