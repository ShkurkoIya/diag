...
static asn_oer_constraints_t asn_OER_type_CellIdentity_PerRL_List_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
asn_per_constraints_t asn_PER_type_CellIdentity_PerRL_List_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_CellIdentity_PerRL_List_1[] = {
	{ ATF_POINTER, 0, 0,
...
asn_SET_OF_specifics_t asn_SPC_CellIdentity_PerRL_List_specs_1 = {
