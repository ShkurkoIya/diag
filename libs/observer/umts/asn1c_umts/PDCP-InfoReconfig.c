...
static asn_oer_constraints_t asn_OER_memb_dummy_constr_3 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
static asn_per_constraints_t asn_PER_memb_dummy_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (0..65535) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_PDCP_InfoReconfig_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PDCP_InfoReconfig, dummy),
		...
		0,
		{ &asn_OER_memb_dummy_constr_3, &asn_PER_memb_dummy_constr_3,  memb_dummy_constraint_1 },
		0, 0, /* No default value */
		"dummy"
		},
};
...
asn_SEQUENCE_specifics_t asn_SPC_PDCP_InfoReconfig_specs_1 = {
