...
extern asn_SEQUENCE_specifics_t asn_SPC_InterRATHandoverInfoWithInterRATCapabilities_r3_IEs_specs_1;
extern asn_TYPE_member_t asn_MBR_InterRATHandoverInfoWithInterRATCapabilities_r3_IEs_1[2];
