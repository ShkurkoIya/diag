...
typedef struct RB_InformationReconfigList_r6 {
    A_SEQUENCE_OF(struct RB_InformationReconfig_r6)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_RB_InformationReconfigList_r6_specs_1;
extern asn_TYPE_member_t asn_MBR_RB_InformationReconfigList_r6_1[1];
extern asn_per_constraints_t asn_PER_type_RB_InformationReconfigList_r6_constr_1;
