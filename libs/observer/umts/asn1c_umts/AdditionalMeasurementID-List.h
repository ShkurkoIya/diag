...
typedef struct AdditionalMeasurementID_List {
    A_SEQUENCE_OF(MeasurementIdentity_t)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_AdditionalMeasurementID_List_specs_1;
extern asn_TYPE_member_t asn_MBR_AdditionalMeasurementID_List_1[1];
extern asn_per_constraints_t asn_PER_type_AdditionalMeasurementID_List_constr_1;
