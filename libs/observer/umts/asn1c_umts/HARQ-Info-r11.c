...
asn_TYPE_member_t asn_MBR_HARQ_Info_r11_1[] = {
...
static const ber_tlv_tag_t asn_DEF_HARQ_Info_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_HARQ_Info_r11_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* numberOfProcesses */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* memoryPartitioning */
};
asn_SEQUENCE_specifics_t asn_SPC_HARQ_Info_r11_specs_1 = {
