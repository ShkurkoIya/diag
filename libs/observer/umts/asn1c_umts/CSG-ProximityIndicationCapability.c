 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_supportOfIntraFreqProximityIndication_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_supportOfIntraFreqProximityIndication_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_supportOfInterFreqProximityIndication_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_supportOfInterFreqProximityIndication_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_supportOfE_UtraProximityIndication_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_supportOfE_UtraProximityIndication_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_supportOfIntraFreqProximityIndication_value2enum_2[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_supportOfIntraFreqProximityIndication_enum2value_2[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_supportOfIntraFreqProximityIndication_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_supportOfIntraFreqProximityIndication_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_supportOfIntraFreqProximityIndication_2 = {
	...
	{ &asn_OER_type_supportOfIntraFreqProximityIndication_constr_2, &asn_PER_type_supportOfIntraFreqProximityIndication_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_supportOfIntraFreqProximityIndication_specs_2	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_supportOfInterFreqProximityIndication_value2enum_4[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_supportOfInterFreqProximityIndication_enum2value_4[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_supportOfInterFreqProximityIndication_specs_4 = {
...
static const ber_tlv_tag_t asn_DEF_supportOfInterFreqProximityIndication_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_supportOfInterFreqProximityIndication_4 = {
	...
	{ &asn_OER_type_supportOfInterFreqProximityIndication_constr_4, &asn_PER_type_supportOfInterFreqProximityIndication_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_supportOfInterFreqProximityIndication_specs_4	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_supportOfE_UtraProximityIndication_value2enum_6[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_supportOfE_UtraProximityIndication_enum2value_6[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_supportOfE_UtraProximityIndication_specs_6 = {
...
static const ber_tlv_tag_t asn_DEF_supportOfE_UtraProximityIndication_tags_6[] = {
...
asn_TYPE_descriptor_t asn_DEF_supportOfE_UtraProximityIndication_6 = {
	...
	{ &asn_OER_type_supportOfE_UtraProximityIndication_constr_6, &asn_PER_type_supportOfE_UtraProximityIndication_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_supportOfE_UtraProximityIndication_specs_6	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_CSG_ProximityIndicationCapability_1[] = {
...
static const int asn_MAP_CSG_ProximityIndicationCapability_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_CSG_ProximityIndicationCapability_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CSG_ProximityIndicationCapability_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportOfIntraFreqProximityIndication */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* supportOfInterFreqProximityIndication */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* supportOfE-UtraProximityIndication */
};
asn_SEQUENCE_specifics_t asn_SPC_CSG_ProximityIndicationCapability_specs_1 = {
