...
typedef struct AdditionalDLSecCellInfoListFDD {
    A_SEQUENCE_OF(struct AdditionalDLSecCellInfoFDD)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_AdditionalDLSecCellInfoListFDD_specs_1;
extern asn_TYPE_member_t asn_MBR_AdditionalDLSecCellInfoListFDD_1[1];
extern asn_per_constraints_t asn_PER_type_AdditionalDLSecCellInfoListFDD_constr_1;
