 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_loggedMeasReportRequest_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_loggedMeasReportRequest_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_loggedANRReportRequest_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_loggedANRReportRequest_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_connectionEstablishmentFailureRequest_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_connectionEstablishmentFailureRequest_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_loggedMeasReportRequest_value2enum_2[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_loggedMeasReportRequest_enum2value_2[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_loggedMeasReportRequest_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_loggedMeasReportRequest_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_loggedMeasReportRequest_2 = {
	...
	{ &asn_OER_type_loggedMeasReportRequest_constr_2, &asn_PER_type_loggedMeasReportRequest_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_loggedMeasReportRequest_specs_2	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_loggedANRReportRequest_value2enum_4[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_loggedANRReportRequest_enum2value_4[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_loggedANRReportRequest_specs_4 = {
...
static const ber_tlv_tag_t asn_DEF_loggedANRReportRequest_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_loggedANRReportRequest_4 = {
	...
	{ &asn_OER_type_loggedANRReportRequest_constr_4, &asn_PER_type_loggedANRReportRequest_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_loggedANRReportRequest_specs_4	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_connectionEstablishmentFailureRequest_value2enum_6[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_connectionEstablishmentFailureRequest_enum2value_6[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_connectionEstablishmentFailureRequest_specs_6 = {
...
static const ber_tlv_tag_t asn_DEF_connectionEstablishmentFailureRequest_tags_6[] = {
...
asn_TYPE_descriptor_t asn_DEF_connectionEstablishmentFailureRequest_6 = {
	...
	{ &asn_OER_type_connectionEstablishmentFailureRequest_constr_6, &asn_PER_type_connectionEstablishmentFailureRequest_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_connectionEstablishmentFailureRequest_specs_6	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_UEInformationRequest_r11_IEs_1[] = {
...
static const int asn_MAP_UEInformationRequest_r11_IEs_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_UEInformationRequest_r11_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UEInformationRequest_r11_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* loggedMeasReportRequest */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* loggedANRReportRequest */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* connectionEstablishmentFailureRequest */
};
asn_SEQUENCE_specifics_t asn_SPC_UEInformationRequest_r11_IEs_specs_1 = {
