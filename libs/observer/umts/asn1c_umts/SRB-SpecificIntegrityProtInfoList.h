...
typedef struct SRB_SpecificIntegrityProtInfoList {
    A_SEQUENCE_OF(struct SRB_SpecificIntegrityProtInfo)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_SRB_SpecificIntegrityProtInfoList_specs_1;
extern asn_TYPE_member_t asn_MBR_SRB_SpecificIntegrityProtInfoList_1[1];
extern asn_per_constraints_t asn_PER_type_SRB_SpecificIntegrityProtInfoList_constr_1;
