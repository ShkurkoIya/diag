...
typedef struct CipheringInfoPerRB_List {
    A_SEQUENCE_OF(struct CipheringInfoPerRB)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_CipheringInfoPerRB_List_specs_1;
extern asn_TYPE_member_t asn_MBR_CipheringInfoPerRB_List_1[1];
extern asn_per_constraints_t asn_PER_type_CipheringInfoPerRB_List_constr_1;
