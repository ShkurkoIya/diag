...
asn_TYPE_member_t asn_MBR_UL_EDCH_Information_r8_1[] = {
...
static const int asn_MAP_UL_EDCH_Information_r8_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_UL_EDCH_Information_r8_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UL_EDCH_Information_r8_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mac-es-e-resetIndicator */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* modeSpecificInfo */
};
asn_SEQUENCE_specifics_t asn_SPC_UL_EDCH_Information_r8_specs_1 = {
