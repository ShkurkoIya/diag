...
typedef struct RL_AdditionInformationList {
    A_SEQUENCE_OF(struct RL_AdditionInformation)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_RL_AdditionInformationList_specs_1;
extern asn_TYPE_member_t asn_MBR_RL_AdditionInformationList_1[1];
extern asn_per_constraints_t asn_PER_type_RL_AdditionInformationList_constr_1;
