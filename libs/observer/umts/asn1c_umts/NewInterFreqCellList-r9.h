...
typedef struct NewInterFreqCellList_r9 {
    A_SEQUENCE_OF(struct NewInterFreqCell_r9)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_NewInterFreqCellList_r9_specs_1;
extern asn_TYPE_member_t asn_MBR_NewInterFreqCellList_r9_1[1];
extern asn_per_constraints_t asn_PER_type_NewInterFreqCellList_r9_constr_1;
