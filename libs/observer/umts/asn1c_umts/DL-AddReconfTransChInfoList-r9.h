...
typedef struct DL_AddReconfTransChInfoList_r9 {
    A_SEQUENCE_OF(struct DL_AddReconfTransChInformation_r9)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_DL_AddReconfTransChInfoList_r9_specs_1;
extern asn_TYPE_member_t asn_MBR_DL_AddReconfTransChInfoList_r9_1[1];
extern asn_per_constraints_t asn_PER_type_DL_AddReconfTransChInfoList_r9_constr_1;
