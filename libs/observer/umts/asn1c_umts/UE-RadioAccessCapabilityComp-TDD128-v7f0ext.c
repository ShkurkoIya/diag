 ...
 */
static int
memb_tdd_edch_PhysicalLayerCategory_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_supportForCSVoiceoverHSPA_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_supportForCSVoiceoverHSPA_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_tdd_edch_PhysicalLayerCategory_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (1..6) */,
	-1};
static asn_per_constraints_t asn_PER_memb_tdd_edch_PhysicalLayerCategory_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  1,  6 }	/* (1..6) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_supportForCSVoiceoverHSPA_value2enum_6[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_supportForCSVoiceoverHSPA_enum2value_6[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_supportForCSVoiceoverHSPA_specs_6 = {
...
static const ber_tlv_tag_t asn_DEF_supportForCSVoiceoverHSPA_tags_6[] = {
...
asn_TYPE_descriptor_t asn_DEF_supportForCSVoiceoverHSPA_6 = {
	...
	{ &asn_OER_type_supportForCSVoiceoverHSPA_constr_6, &asn_PER_type_supportForCSVoiceoverHSPA_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_supportForCSVoiceoverHSPA_specs_6	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_UE_RadioAccessCapabilityComp_TDD128_v7f0ext_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct UE_RadioAccessCapabilityComp_TDD128_v7f0ext, tdd_edch_PhysicalLayerCategory),
		...
		0,
		{ &asn_OER_memb_tdd_edch_PhysicalLayerCategory_constr_4, &asn_PER_memb_tdd_edch_PhysicalLayerCategory_constr_4,  memb_tdd_edch_PhysicalLayerCategory_constraint_1 },
		0, 0, /* No default value */
...
static const int asn_MAP_UE_RadioAccessCapabilityComp_TDD128_v7f0ext_oms_1[] = { 0, 1, 2, 3, 4, 5 };
static const ber_tlv_tag_t asn_DEF_UE_RadioAccessCapabilityComp_TDD128_v7f0ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapabilityComp_TDD128_v7f0ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* hSDSCH-physical-layer-category */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* multiCarrier-physical-layer-category */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* tdd-edch-PhysicalLayerCategory */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* dl-CapabilityWithSimultaneousHS-DSCHConfig */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* supportForCSVoiceoverHSPA */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* totalRLC-AM-BufferSize */
};
asn_SEQUENCE_specifics_t asn_SPC_UE_RadioAccessCapabilityComp_TDD128_v7f0ext_specs_1 = {
