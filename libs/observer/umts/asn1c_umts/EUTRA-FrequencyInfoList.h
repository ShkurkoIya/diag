...
typedef struct EUTRA_FrequencyInfoList {
    A_SEQUENCE_OF(struct EUTRA_FrequencyInfo)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_EUTRA_FrequencyInfoList_specs_1;
extern asn_TYPE_member_t asn_MBR_EUTRA_FrequencyInfoList_1[1];
extern asn_per_constraints_t asn_PER_type_EUTRA_FrequencyInfoList_constr_1;
