...
typedef struct PDSCH_SysInfoList_VHCR_r7 {
    A_SEQUENCE_OF(struct PDSCH_SysInfo_VHCR_r7)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_PDSCH_SysInfoList_VHCR_r7_specs_1;
extern asn_TYPE_member_t asn_MBR_PDSCH_SysInfoList_VHCR_r7_1[1];
extern asn_per_constraints_t asn_PER_type_PDSCH_SysInfoList_VHCR_r7_constr_1;
