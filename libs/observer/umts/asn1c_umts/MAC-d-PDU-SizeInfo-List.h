...
typedef struct MAC_d_PDU_SizeInfo_List {
    A_SEQUENCE_OF(struct MAC_d_PDUsizeInfo)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_MAC_d_PDU_SizeInfo_List_specs_1;
extern asn_TYPE_member_t asn_MBR_MAC_d_PDU_SizeInfo_List_1[1];
extern asn_per_constraints_t asn_PER_type_MAC_d_PDU_SizeInfo_List_constr_1;
