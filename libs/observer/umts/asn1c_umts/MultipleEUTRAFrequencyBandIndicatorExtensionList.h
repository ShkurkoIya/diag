...
typedef struct MultipleEUTRAFrequencyBandIndicatorExtensionList {
    A_SEQUENCE_OF(RadioFrequencyBandEUTRAExt_t)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_MultipleEUTRAFrequencyBandIndicatorExtensionList_specs_1;
extern asn_TYPE_member_t asn_MBR_MultipleEUTRAFrequencyBandIndicatorExtensionList_1[1];
extern asn_per_constraints_t asn_PER_type_MultipleEUTRAFrequencyBandIndicatorExtensionList_constr_1;
