...
typedef struct OngoingMeasRepList_r10 {
    A_SEQUENCE_OF(struct OngoingMeasRep_r10)
    list;
...
extern asn_SET_OF_specifics_t asn_SPC_OngoingMeasRepList_r10_specs_1;
extern asn_TYPE_member_t asn_MBR_OngoingMeasRepList_r10_1[1];
extern asn_per_constraints_t asn_PER_type_OngoingMeasRepList_r10_constr_1;
