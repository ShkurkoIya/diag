...
asn_TYPE_member_t asn_MBR_StoredCompressedModeInfo_r8_1[] = {
...
static const int asn_MAP_StoredCompressedModeInfo_r8_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_StoredCompressedModeInfo_r8_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_StoredCompressedModeInfo_r8_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* storedTGP-SequenceList */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* codeChangeStatusList */
};
asn_SEQUENCE_specifics_t asn_SPC_StoredCompressedModeInfo_r8_specs_1 = {
