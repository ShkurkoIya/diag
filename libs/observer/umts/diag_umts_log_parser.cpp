...
const char *DiagUmtsLogParser::nas_msg_name(uint8_t pd, uint8_t msg_type) {
    ...
    if (pd == PD_GMM) {
        switch (msg_type) {
            ...
            case 0x0B:
                return "RAU Reject";
            case 0x10:
                return "P-TMSI Realloc Command";
            case 0x11:
                return "P-TMSI Realloc Complete";
            case 0x12:
                return "Auth & Cipher Request";
            case 0x13:
                return "Auth & Cipher Response";
            case 0x14:
                return "Auth & Cipher Reject";
            case 0x1C:
    ...
    if (pd == PD_MM) {
        switch (msg_type) {
            ...
            case 0x23:
                return "CM Service Abort";
            case 0x24:
                return "CM Service Request";
            case 0x25:
                return "CM Service Prompt";
            case 0x29:
                return "CM Re-establishment Request";
            case 0x2A:
                return "Abort";
            case 0x30:
                return "MM Null";
    ...
    if (pd == PD_SM) {
        switch (msg_type) {
            ...
            case 0x48:
                return "Modify PDP Context Request (UE)";
            case 0x49:
                return "Modify PDP Context Accept";
            case 0x55:
                return "SM Status";
            default:
                return "SM Unknown";
