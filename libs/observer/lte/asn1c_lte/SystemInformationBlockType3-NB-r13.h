...
typedef struct SystemInformationBlockType3_NB_r13 {
    ...
    struct SystemInformationBlockType3_NB_r13__multiBandInfoList_r13 {
        A_SEQUENCE_OF(struct NS_PmaxList_NB_r13)
        list;
    ...
    struct ConnMeasConfig_NB_r17 *connMeasConfig_r17 /* OPTIONAL */;
    TimeOffsetUTC_r17_t *t_Service_r17 /* OPTIONAL */;
    struct SystemInformationBlockType3_NB_r13__satelliteAssistanceInfo_r18 {
...
extern asn_TYPE_member_t asn_MBR_SystemInformationBlockType3_NB_r13_1[15];
