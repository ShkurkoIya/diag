...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType22_NB_r14_1[] = {
	{ ATF_POINTER, 9, offsetof(struct SystemInformationBlockType22_NB_r14, dl_ConfigList_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_DL_ConfigCommonList_NB_r14,
		0,
	...
	{ ATF_POINTER, 8, offsetof(struct SystemInformationBlockType22_NB_r14, ul_ConfigList_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_UL_ConfigCommonList_NB_r14,
		0,
	...
	{ ATF_POINTER, 7, offsetof(struct SystemInformationBlockType22_NB_r14, pagingWeightAnchor_r14),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct SystemInformationBlockType22_NB_r14, nprach_ProbabilityAnchorList_r14),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct SystemInformationBlockType22_NB_r14, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType22_NB_r14, mixedOperationModeConfig_r15),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType22_NB_r14, ul_ConfigList_r15),
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType22_NB_r14, coverageBasedPagingConfig_r17),
		...
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"coverageBasedPagingConfig-r17"
		},
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType22_NB_r14, cb_Msg3_ProbabilityAnchorList_NB_r19),
...
static const int asn_MAP_SystemInformationBlockType22_NB_r14_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
...
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType22_NB_r14_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* coverageBasedPagingConfig-r17 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 } /* cb-Msg3-ProbabilityAnchorList-NB-r19 */
};
