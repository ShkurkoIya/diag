 ...
 */
static int
memb_uac_AC1_SelectAssistInfo_r16_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static asn_oer_constraints_t asn_OER_type_ab_PerRSRP_r16_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_ab_PerRSRP_r16_constr_11 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_uac_AC1_SelectAssistInfo_r16_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(2..6)) */};
static asn_per_constraints_t asn_PER_type_uac_AC1_SelectAssistInfo_r16_constr_16 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  2,  6 }	/* (SIZE(2..6)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_uac_AC1_SelectAssistInfo_r16_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(2..6)) */};
static asn_per_constraints_t asn_PER_memb_uac_AC1_SelectAssistInfo_r16_constr_16 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  2,  6 }	/* (SIZE(2..6)) */,
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_ab_PerRSRP_r16_value2enum_11[] = {
	{ 0,	7,	"thresh0" },
	{ 1,	7,	"thresh1" },
	{ 2,	7,	"thresh2" },
	{ 3,	7,	"thresh3" }
};
static const unsigned int asn_MAP_ab_PerRSRP_r16_enum2value_11[] = {
	0,	/* thresh0(0) */
	1,	/* thresh1(1) */
	2,	/* thresh2(2) */
	3	/* thresh3(3) */
};
static const asn_INTEGER_specifics_t asn_SPC_ab_PerRSRP_r16_specs_11 = {
	asn_MAP_ab_PerRSRP_r16_value2enum_11,	/* "tag" => N; sorted by tag */
	asn_MAP_ab_PerRSRP_r16_enum2value_11,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_ab_PerRSRP_r16_tags_11[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ab_PerRSRP_r16_11 = {
	"ab-PerRSRP-r16",
	"ab-PerRSRP-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_ab_PerRSRP_r16_tags_11,
	sizeof(asn_DEF_ab_PerRSRP_r16_tags_11)
		/sizeof(asn_DEF_ab_PerRSRP_r16_tags_11[0]) - 1, /* 1 */
	asn_DEF_ab_PerRSRP_r16_tags_11,	/* Same as above */
	sizeof(asn_DEF_ab_PerRSRP_r16_tags_11)
		/sizeof(asn_DEF_ab_PerRSRP_r16_tags_11[0]), /* 2 */
	{ &asn_OER_type_ab_PerRSRP_r16_constr_11, &asn_PER_type_ab_PerRSRP_r16_constr_11, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_ab_PerRSRP_r16_specs_11	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_uac_AC1_SelectAssistInfo_r16_16[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (10 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_uac_AC1_SelectAssistInfo_r16_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_uac_AC1_SelectAssistInfo_r16_specs_16 = {
	sizeof(struct SystemInformationBlockType25_r15__uac_AC1_SelectAssistInfo_r16),
	offsetof(struct SystemInformationBlockType25_r15__uac_AC1_SelectAssistInfo_r16, _asn_ctx),
	1,	/* XER encoding is XMLValueList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_uac_AC1_SelectAssistInfo_r16_16 = {
	"uac-AC1-SelectAssistInfo-r16",
	"uac-AC1-SelectAssistInfo-r16",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_uac_AC1_SelectAssistInfo_r16_tags_16,
	sizeof(asn_DEF_uac_AC1_SelectAssistInfo_r16_tags_16)
		/sizeof(asn_DEF_uac_AC1_SelectAssistInfo_r16_tags_16[0]) - 1, /* 1 */
	asn_DEF_uac_AC1_SelectAssistInfo_r16_tags_16,	/* Same as above */
	sizeof(asn_DEF_uac_AC1_SelectAssistInfo_r16_tags_16)
		/sizeof(asn_DEF_uac_AC1_SelectAssistInfo_r16_tags_16[0]), /* 2 */
	{ &asn_OER_type_uac_AC1_SelectAssistInfo_r16_constr_16, &asn_PER_type_uac_AC1_SelectAssistInfo_r16_constr_16, SEQUENCE_OF_constraint },
	asn_MBR_uac_AC1_SelectAssistInfo_r16_16,
	1,	/* Single element */
	&asn_SPC_uac_AC1_SelectAssistInfo_r16_specs_16	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType25_r15_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType25_r15, ab_PerRSRP_r16),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ab_PerRSRP_r16_11,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ab-PerRSRP-r16"
		},
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType25_r15, uac_AC1_SelectAssistInfo_r16),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_uac_AC1_SelectAssistInfo_r16_16,
		0,
		{ &asn_OER_memb_uac_AC1_SelectAssistInfo_r16_constr_16, &asn_PER_memb_uac_AC1_SelectAssistInfo_r16_constr_16,  memb_uac_AC1_SelectAssistInfo_r16_constraint_1 },
		0, 0, /* No default value */
		"uac-AC1-SelectAssistInfo-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType25_r15, uac_BarringInfoSetList_v1700),
...
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType25_r15_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* ab-PerRSRP-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* uac-AC1-SelectAssistInfo-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* uac-BarringInfoSetList-v1700 */
};
