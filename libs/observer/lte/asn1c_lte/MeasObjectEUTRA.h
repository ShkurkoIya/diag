...
struct SetupRelease;
struct CellsToAddModList_v1810;
...
typedef struct MeasObjectEUTRA {
    ...
    struct SetupRelease *measRSS_DedicatedConfig_r16 /* OPTIONAL */;
    struct CellsToAddModList_v1810 *cellsToAddModList_v1810 /* OPTIONAL */;
...
extern asn_TYPE_member_t asn_MBR_MeasObjectEUTRA_1[28];
