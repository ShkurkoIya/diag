...
asn_TYPE_member_t asn_MBR_AS_Config_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct AS_Config, sourceSystemInformationBlockType1Ext),
	...
	{ ATF_POINTER, 7, offsetof(struct AS_Config, sourceOtherConfig_r9),
	...
	{ ATF_POINTER, 6, offsetof(struct AS_Config, sourceSCellConfigList_r10),
	...
	{ ATF_POINTER, 5, offsetof(struct AS_Config, sourceConfigSCG_r12),
	...
	{ ATF_POINTER, 4, offsetof(struct AS_Config, as_ConfigNR_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct AS_Config, as_Config_v1550),
	...
	{ ATF_POINTER, 2, offsetof(struct AS_Config, as_ConfigNR_v1570),
	...
	{ ATF_POINTER, 1, offsetof(struct AS_Config, as_ConfigNR_v1620),
...
static const int asn_MAP_AS_Config_oms_1[] = { 9, 10, 11, 12, 13, 14, 15, 16 };
...
static const asn_TYPE_tag2member_t asn_MAP_AS_Config_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (15 << 2)), 15, 0, 0 }, /* as-ConfigNR-v1570 */
    { (ASN_TAG_CLASS_CONTEXT | (16 << 2)), 16, 0, 0 } /* as-ConfigNR-v1620 */
};
