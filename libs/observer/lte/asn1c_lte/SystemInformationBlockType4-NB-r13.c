...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType4_NB_r13_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType4_NB_r13, intraFreqExcludedCellList_r13),
...
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType4_NB_r13_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* intraFreqExcludedCellList-r13 */
