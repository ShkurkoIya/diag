...
static asn_oer_constraints_t asn_OER_type_sigLoggedMeasType_r18_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_sigLoggedMeasType_r18_constr_8 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_sigLoggedMeasType_r18_value2enum_8[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_sigLoggedMeasType_r18_enum2value_8[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_sigLoggedMeasType_r18_specs_8 = {
	asn_MAP_sigLoggedMeasType_r18_value2enum_8,	/* "tag" => N; sorted by tag */
	asn_MAP_sigLoggedMeasType_r18_enum2value_8,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_sigLoggedMeasType_r18_tags_8[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_sigLoggedMeasType_r18_8 = {
	"sigLoggedMeasType-r18",
	"sigLoggedMeasType-r18",
	&asn_OP_NativeEnumerated,
	asn_DEF_sigLoggedMeasType_r18_tags_8,
	sizeof(asn_DEF_sigLoggedMeasType_r18_tags_8)
		/sizeof(asn_DEF_sigLoggedMeasType_r18_tags_8[0]) - 1, /* 1 */
	asn_DEF_sigLoggedMeasType_r18_tags_8,	/* Same as above */
	sizeof(asn_DEF_sigLoggedMeasType_r18_tags_8)
		/sizeof(asn_DEF_sigLoggedMeasType_r18_tags_8[0]), /* 2 */
	{ &asn_OER_type_sigLoggedMeasType_r18_constr_8, &asn_PER_type_sigLoggedMeasType_r18_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_sigLoggedMeasType_r18_specs_8	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_VarLogMeasReport_r11_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VarLogMeasReport_r11, sigLoggedMeasType_r18),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_sigLoggedMeasType_r18_8,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"sigLoggedMeasType-r18"
...
static const asn_TYPE_tag2member_t asn_MAP_VarLogMeasReport_r11_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* sigLoggedMeasType-r18 */
};
