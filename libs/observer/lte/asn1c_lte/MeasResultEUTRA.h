...
typedef enum MeasResultEUTRA__measResult__hsdn_Cell_r19 {
    MeasResultEUTRA__measResult__hsdn_Cell_r19_true = 0
} e_MeasResultEUTRA__measResult__hsdn_Cell_r19;
...
typedef struct MeasResultEUTRA {
    ...
    struct MeasResultEUTRA__measResult {
        ...
        struct MeasResultEUTRA__measResult__cgi_Info_5GC_r15 {
            A_SEQUENCE_OF(struct CellAccessRelatedInfo_5GC_r15)
            list;
...
/* extern asn_TYPE_descriptor_t asn_DEF_hsdn_Cell_r19_24;	// (Use -fall-defs-global to expose) */
