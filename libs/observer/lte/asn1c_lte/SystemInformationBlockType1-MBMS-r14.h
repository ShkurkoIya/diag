...
struct SystemInformationBlockType1_MBMS_v1900;
...
typedef struct SystemInformationBlockType1_MBMS_r14 {
    ...
    struct SystemInformationBlockType1_MBMS_r14__cellAccessRelatedInfoList_r14 {
        A_SEQUENCE_OF(struct CellAccessRelatedInfo_r14)
        list;

        /* Context for parsing across buffer boundaries */
        asn_struct_ctx_t _asn_ctx;
    } *cellAccessRelatedInfoList_r14;
    struct SystemInformationBlockType1_MBMS_v1900 *nonCriticalExtension /* OPTIONAL */;
