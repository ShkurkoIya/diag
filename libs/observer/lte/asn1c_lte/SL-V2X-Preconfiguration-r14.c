...
static asn_TYPE_member_t asn_MBR_SL_V2X_Preconfiguration_r14_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct SL_V2X_Preconfiguration_r14, anchorCarrierFreqList_r14),
	...
	{ ATF_POINTER, 6, offsetof(struct SL_V2X_Preconfiguration_r14, cbr_PreconfigList_r14),
	...
	{ ATF_POINTER, 5, offsetof(struct SL_V2X_Preconfiguration_r14, v2x_PacketDuplicationConfig_r15),
	...
	{ ATF_POINTER, 4, offsetof(struct SL_V2X_Preconfiguration_r14, syncFreqList_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct SL_V2X_Preconfiguration_r14, slss_TxMultiFreq_r15),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SL_V2X_Preconfiguration_r14, v2x_TxProfileList_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_Preconfiguration_r14, anchorCarrierFreqListNR_r16),
...
static const int asn_MAP_SL_V2X_Preconfiguration_r14_oms_1[] = { 1, 2, 3, 4, 5, 6, 7 };
...
static const asn_TYPE_tag2member_t asn_MAP_SL_V2X_Preconfiguration_r14_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* anchorCarrierFreqListNR-r16 */
};
