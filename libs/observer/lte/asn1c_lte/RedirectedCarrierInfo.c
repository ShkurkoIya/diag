...
asn_TYPE_member_t asn_MBR_RedirectedCarrierInfo_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RedirectedCarrierInfo, choice.nr_r19),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RedirectedCarrierInfo, choice.eutra_NTN_r19),
...
static const asn_TYPE_tag2member_t asn_MAP_RedirectedCarrierInfo_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, /* nr-r19 */
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 } /* eutra-NTN-r19 */
};
