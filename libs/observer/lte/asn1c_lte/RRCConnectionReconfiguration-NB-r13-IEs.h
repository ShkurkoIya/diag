...
struct RRCConnectionReconfiguration_NB_v16f0_IEs;
...
typedef struct RRCConnectionReconfiguration_NB_r13_IEs {
    struct RRCConnectionReconfiguration_NB_r13_IEs__dedicatedInfoNASList_r13 {
        A_SEQUENCE_OF(DedicatedInfoNAS_t)
        list;
    ...
    struct RRCConnectionReconfiguration_NB_v16f0_IEs *nonCriticalExtension /* OPTIONAL */;
