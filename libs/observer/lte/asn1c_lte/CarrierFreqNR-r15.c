...
asn_TYPE_member_t asn_MBR_CarrierFreqNR_r15_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct CarrierFreqNR_r15, maxRS_IndexCellQual_r15),
	...
	{ ATF_POINTER, 7, offsetof(struct CarrierFreqNR_r15, threshRS_Index_r15),
	...
	{ ATF_POINTER, 6, offsetof(struct CarrierFreqNR_r15, multiBandNsPmaxListNR_v1550),
	...
	{ ATF_POINTER, 5, offsetof(struct CarrierFreqNR_r15, multiBandNsPmaxListNR_SUL_v1550),
	...
	{ ATF_POINTER, 4, offsetof(struct CarrierFreqNR_r15, ssb_ToMeasure_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct CarrierFreqNR_r15, ns_PmaxListNR_v1760),
	...
	{ ATF_POINTER, 2, offsetof(struct CarrierFreqNR_r15, multiBandNsPmaxListNR_v1760),
	...
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqNR_r15, multiBandNsPmaxListNR_SUL_v1760),
...
static const int asn_MAP_CarrierFreqNR_r15_oms_1[] = { 1, 2, 3, 5, 6, 7, 10, 12, 14, 15, 17, 18, 19, 20, 21, 22, 23, 24 };
...
static const asn_TYPE_tag2member_t asn_MAP_CarrierFreqNR_r15_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (22 << 2)), 22, 0, 0 }, /* ns-PmaxListNR-v1760 */
    { (ASN_TAG_CLASS_CONTEXT | (23 << 2)), 23, 0, 0 }, /* multiBandNsPmaxListNR-v1760 */
    { (ASN_TAG_CLASS_CONTEXT | (24 << 2)), 24, 0, 0 } /* multiBandNsPmaxListNR-SUL-v1760 */
};
