...
typedef enum MeasConfig__timeMeasConfig_r18 {
    MeasConfig__timeMeasConfig_r18_true = 0
} e_MeasConfig__timeMeasConfig_r18;
typedef enum MeasConfig__locationMeasConfig_r18 {
    MeasConfig__locationMeasConfig_r18_true = 0
} e_MeasConfig__locationMeasConfig_r18;
...
typedef struct MeasConfig {
    ...
    long *timeMeasConfig_r18 /* OPTIONAL */;
    long *locationMeasConfig_r18 /* OPTIONAL */;
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_timeMeasConfig_r18_38;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_locationMeasConfig_r18_40;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_MeasConfig;
extern asn_SEQUENCE_specifics_t asn_SPC_MeasConfig_specs_1;
extern asn_TYPE_member_t asn_MBR_MeasConfig_1[29];
