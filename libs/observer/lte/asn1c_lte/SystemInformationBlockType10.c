...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType10_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType10, dummy),
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType10, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType10, warningAreaCoordinates_r19),
...
static const int asn_MAP_SystemInformationBlockType10_oms_1[] = { 3, 4, 5 };
...
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType10_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* warningAreaCoordinates-r19 */
};
