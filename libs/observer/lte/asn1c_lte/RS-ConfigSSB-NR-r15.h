...
typedef enum RS_ConfigSSB_NR_r15__subcarrierSpacingSSB_r17 {
    RS_ConfigSSB_NR_r15__subcarrierSpacingSSB_r17_kHz480 = 0,
    RS_ConfigSSB_NR_r15__subcarrierSpacingSSB_r17_kHz960 = 1
} e_RS_ConfigSSB_NR_r15__subcarrierSpacingSSB_r17;
...
typedef struct RS_ConfigSSB_NR_r15 {
    ...
    struct RS_ConfigSSB_NR_r15__ssb_PositionQCL_CellsToRemoveListNR_r16 {
        A_SEQUENCE_OF(PhysCellIdNR_r15_t)
        list;
    ...
    struct RS_ConfigSSB_NR_r15__ssb_PositionQCL_CellsToRemoveListNR_r17 {
        A_SEQUENCE_OF(PhysCellIdNR_r15_t)
        list;
...
/* extern asn_TYPE_descriptor_t asn_DEF_subcarrierSpacingSSB_r17_16;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_RS_ConfigSSB_NR_r15_1[10];
