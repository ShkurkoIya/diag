...
asn_TYPE_member_t asn_MBR_SRB_ToAddMod_NB_r13_1[] = {
	{ ATF_POINTER, 4, offsetof(struct SRB_ToAddMod_NB_r13, rlc_Config_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct SRB_ToAddMod_NB_r13, logicalChannelConfig_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SRB_ToAddMod_NB_r13, rlc_Config_v1430),
	...
	{ ATF_POINTER, 1, offsetof(struct SRB_ToAddMod_NB_r13, rlc_Config_v1700),
...
static const int asn_MAP_SRB_ToAddMod_NB_r13_oms_1[] = { 0, 1, 2, 3 };
...
static const asn_TYPE_tag2member_t asn_MAP_SRB_ToAddMod_NB_r13_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* rlc-Config-v1700 */
};
