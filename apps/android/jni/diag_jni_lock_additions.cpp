...
// ─────────────────────────────────────────────────────────────────────────────
extern "C" JNI_METHOD(jboolean, nativeLockLte)(JNIEnv * /*env*/, jobject /*thiz*/,
...
// ─────────────────────────────────────────────────────────────────────────────
extern "C" JNI_METHOD(jboolean, nativeUnlockLte)(JNIEnv * /*env*/, jobject /*thiz*/) {
    std::lock_guard<std::mutex> lk(g_init_mx);
...
// ─────────────────────────────────────────────────────────────────────────────
extern "C" JNI_METHOD(jboolean, nativeLockNr)(JNIEnv * /*env*/, jobject /*thiz*/,
...
// ─────────────────────────────────────────────────────────────────────────────
extern "C" JNI_METHOD(jboolean, nativeUnlockNr)(JNIEnv * /*env*/, jobject /*thiz*/) {
    std::lock_guard<std::mutex> lk(g_init_mx);
...
// ─────────────────────────────────────────────────────────────────────────────
extern "C" JNI_METHOD(jboolean, nativeIsLocked)(JNIEnv * /*env*/, jobject /*thiz*/) {
    std::lock_guard<std::mutex> lk(g_init_mx);
...
// ─────────────────────────────────────────────────────────────────────────────
extern "C" JNI_METHOD(jobjectArray, nativeEfsListDir)(JNIEnv *env, jobject /*thiz*/,
                                                      jstring jpath) {
    std::lock_guard<std::mutex> lk(g_init_mx);
    if (!g_client || g_client->state() != DiagDciClient::State::Running) {
        return nullptr;
...
// ─────────────────────────────────────────────────────────────────────────────
extern "C" JNI_METHOD(jbyteArray, nativeEfsReadFile)(JNIEnv *env, jobject /*thiz*/,
                                                     jstring jpath) {
    std::lock_guard<std::mutex> lk(g_init_mx);
